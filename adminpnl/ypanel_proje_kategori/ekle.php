                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="kontrol.php">Proje Kategorileri</a> &gt;</li>
                                        </ul>
                                    </div>
                        ...
                        <div class="row" style="background:#FFFFFF"> 
                                    ...
                                    <tr> 
                                          ...
                                          <td  valign="top"> 
                                            ...
                                            <table border="0" align="center" cellpadding="4" cellspacing="6">
                                              <tr>
                                                <td colspan="3" class="anabaslik">Proje Kategori Ekle</td>
                                              </tr>
                                              <tr> 
                                                <td>&nbsp;</td>
                                                <td>
                                              ...
                                              <tr> 
                                                ...
                                                <td bgcolor="#F9F9F9">
                                                  ...
                                                  <input name="ad" type="text" class="form-control"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($ad)) {echo $ad; }?>" size="55" onKeyUp="yoltanimla();">                                                </td>
                                              </tr>
                                              
                                               <tr> 
                                                <td > Altbilgi</td>
                                                <td bgcolor="#F9F9F9">
                                                  <? if (isset($_SESSION[$tablo_ismi.'n_aciklama'])) { $ad=$_SESSION[$tablo_ismi.'n_aciklama']; } ?>
                                                  <input name="aciklama" type="text" class="form-control"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($aciklama)) {echo $aciklama; }?>" size="55" >                                                </td>
                                              </tr>
                                           ...
                                           <? /*    <tr> 
                                              ...
                                              <tr>
                                                ...
                                                <input name="altkategorilimi" type="radio" value="var" <? if ($altkategorilimi=="var" || !isset($altkategorilimi)) {print "checked";}; ?>>
                                                  <span class="baslik">Var</span> 
                                                  <input name="altkategorilimi" type="radio" value="yok" <? if ($altkategorilimi=="yok") {print "checked";}; ?>>
                                                <span class="baslik">Yok, Direkt Ürünleri Gireceğim Altına... </span></td>
                                              </tr>
                                            <? /* */ ?>  <tr> 
                                                <td>Resim </td>
                                                <td bgcolor="#F9F9F9">
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <div align="left">
                                            <span style="font-size:12px">Önerilen Ölçüler: <strong><? echo $kck_m_w; ?>px-<? echo $kck_m_h; ?>px</strong></span> 
