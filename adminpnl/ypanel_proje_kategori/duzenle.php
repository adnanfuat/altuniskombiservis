    ...
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
        <table  border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
          <tr>
              <td colspan="2" class="anabaslik">Proje  Kategori Düzenle</td>
            </tr>
          <tr> 
       ...
       <? /*   */ ?> <tr> 
            ...
            <td   bgcolor="#F9F9F9">
              <input name="resim" type="file"  class="form-control" id="resim" onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" size="46">            </td>
            </tr>
          <tr>
            <td height="32">&nbsp;</td>
            <td>
			...
			<img src="<? print($resim_dizini.$resim); ?>"  border="0" style="max-width: 200px;height: auto;">
            </a>
            </div>
            </td>
          </tr>
