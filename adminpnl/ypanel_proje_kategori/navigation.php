<style> 
.sayfa_numara {color:#555; text-decoration:none; font-weight: bold; font-size: 11px; font-family:Tahoma; }
...
.page a{padding: 2px 6px; border: solid 1px #000000; background: #F2F0F0; color: #555; text-decoration: none;margin: 1px}
.page a:visited {padding: 2px 6px; border: solid 1px #000000; background: #F2F0F0; text-decoration: none;margin: 1px}
...
if  (($sayfa_no-5) >= 1) 
    { 
		 $ilksayfa = '<span class="page" ><a href="' . $link . '1' . '" class="sayfa_numara" title="Ýlk Sayfa">« Ýlk</a></span>'."\n"; 
    } 
...
if  (($toplam_sayfa_sayisi-$sayfa_no)>= 5) 
	{ 
		 $enson = '<span class="page" ><a href="' . $link . $toplam_sayfa_sayisi . '" class="sayfa_numara" title="Son Sayfa">Son »</a></span>'."\n"; 
	} 
