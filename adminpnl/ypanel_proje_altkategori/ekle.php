...
<body class="animsition">
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="../ypanel_proje_kategori/kontrol.php"  >Proje Kategori(<? print $ustkategori_adi; ?>)</a> &gt; 
	<a href="kontrol.php?ust_kategori_no=<? print $ustkategori_no; ?>"  >Alt Kategoriler</a> &gt;</li>
                                        </ul>
                                    </div>
  ...
  <tr> 
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td  valign="top"> 
        <table w border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
          <tr>
            <td colspan="2" class="anabaslik">Proje Alt Kategori Ekle </td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
            <td>
          ...
          <tr> 
			...
			<input name="ad" type="text" class="form-control" id="ad" tabindex="1" onFocus="pchange(this, 1);"  onblur="pchange(this, 0);" value="<? if (isset($ad)) { echo $ad;} ?>"  size="55" onKeyUp="yoltanimla();"></td>
          </tr>
          ...
          <tr> 
			...
			<input name="aciklama" type="text" class="form-control" id="aciklama" tabindex="1" onFocus="pchange(this, 1);"  onblur="pchange(this, 0);" value="<? if (isset($aciklama)) { echo $aciklama;} ?>"  size="55"  ></td>
          </tr>
          
            <tr> 
            <td  > Video Link</td>
            <td bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'n_video_link'])) { $video_link=$_SESSION[$tablo_ismi.'n_video_link']; } ?>
			<input name="video_link" type="text" class="form-control" id="video_link" tabindex="1" onFocus="pchange(this, 1);"  onblur="pchange(this, 0);" value="<? if (isset($video_link)) { echo $video_link;} ?>"  size="55"  ></td>
          </tr>
      ...
      <? /*     <tr> 
            <td width="127" class="baslik">Arkaplan</td>
            <td bgcolor="#F9F9F9">
			<? if (isset($_SESSION[$tablo_ismi.'arkaplan'])) { $arkaplan=$_SESSION[$tablo_ismi.'arkaplan']; } ?>
            <input name="arkaplan" type="text" class="form-control"  onfocus="pchange(this, 1);"  onblur="pchange(this, 0);" value="<? if (isset($arkaplan)) {echo $arkaplan; }?>" size="55">
              </td>
          </tr> 
          
          <tr>
            <td align="left" valign="middle"><span class="baslik">Açıklama</span></td>
            <td  valign="baseline"bgcolor="#F9F9F9">
			<? if (isset($_SESSION[$tablo_ismi.'n_aciklama'])) {$aciklama=$_SESSION[$tablo_ismi.'n_aciklama']; } ?>
              <textarea name="aciklama" cols="80" rows="25" class="mceAdvanced"><? echo $aciklama; ?></textarea>            </td>
          </tr>*/ ?>
          <tr>
            <td align="left" valign="middle">Puan</td>
            <td valign="middle" bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'n_siralama'])) { $siralama=$_SESSION[$tablo_ismi.'n_siralama']; } ?>
			<input name="siralama" type="text" id="siralama"  value="<? echo $siralama ?>"  class="form-control" size="10"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);"></td>
          </tr>
         <tr> 
            <td align="left" valign="middle">Resim</td>
            <td bgcolor="#F9F9F9">
              <input name="resim" type="file"  class="form-control" id="resim" onFocus="pchange(this, 1);"  onblur="pchange(this, 0);" size="46">
              <span class="veri_tarih" style="font-size:10px"><? echo $kck_m_w; ?>px-<? echo $kck_m_h; ?>px</span></td>
          </tr> 
          <tr> 
            <td height="32">&nbsp;</td>
            <td>
              <input name="Submit" type="button" class="btn btn-success btn-sm" value="Kaydet" onClick="kontrol()">
              <input name="Submit2" type="button" class="btn btn-info btn-sm"  id="Submit2" onClick="javascript:history.back()"  value="Geri Dön">            </td>
          </tr>
          <tr>
            <td height="32">&nbsp;</td>
         ...
         <? /*  <tr> 
            ...
            <table width="100%" border="0" align="center" cellpadding="2" cellspacing="4">
                <tr> 
                  ...
                  <td width="20%" valign="middle"><div align="left"><font class="veri_tarih">Max. Dosya Boyutu:<strong> <? print $max_file_size ?> kb </strong></font></div></td>
                </tr>
           </table>
           </td>
          </tr> */ ?>
