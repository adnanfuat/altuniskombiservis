                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="../ypanel_proje_kategori/kontrol.php"  >Proje Kategori(<? echo $ustkategori_ad;?>)</a> &gt; 
    ...
    <td>
     <form name="form1" method="post" action="kategori_degistir_islem.php">
      <table    border="0" cellpadding="3" style="max-width:923px">
        <tr>
          <td colspan="2" class="anabaslik">Proje  Kategori Değiştir</td>
        </tr>
        <tr>
          <td colspan="2">
