...
if (isset($_SESSION['yonet']))
   {
		...
		if  (count($alt_kategori)<>0)
			{	  
				...
				$video_link=$alt_kategori[0]["video_link"];
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="../ypanel_proje_kategori/kontrol.php" class="veri_ana_baslik">Proje Kategorileri (<? print $ustkategori_adi; ?>)</a> &gt; 
	<a href="kontrol.php?ust_kategori_no=<? print $ustkategori_no; ?>"  class="veri_ana_baslik">Proje Alt Kategorileri  </a> &gt; </li>
                                        </ul>
                                    </div>
                                        ...
                                        <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
                                          <td  valign="top"> 
                                            <table  border="0" align="center" cellpadding="3" cellspacing="5" style="max-width:923px">
                                              <tr>
                                                <td colspan="2" class="anabaslik">Proje Alt Kategori Düzenle </td>
                                              </tr>
                                              <tr> 
                                                <td ><input name="gizli" type="hidden" id="gizli" value="<? echo $altkategori_no; ?>">
                                              ...
                                              <tr> 
                                                ...
                                                <input name="ad" type="text" id="ad"  value="<? echo $ad ?>"  class="form-control" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);" onKeyUp="yoltanimla();">                                                </td>
                                                </tr>
                                                ...
                                                <input name="aciklama" type="text" id="aciklama"  value="<? echo $aciklama ?>"  class="form-control" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);">                                                </td>
                                                </tr>
                                                
                                                <tr> 
                                                <td>Video Link</td>
                                                <td bgcolor="#F9F9F9">
                                                <? if (isset($_SESSION[$tablo_ismi.'video_link'])) { $video_link=$_SESSION[$tablo_ismi.'video_link']; }  ?>			
                                                <input name="video_link" type="text" id="video_link"  value="<? echo $video_link ?>"  class="form-control" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);">                                                </td>
                                                </tr>
                                            ...
                                            <tr> 
                                             ...
                                             <? /*          <tr> 
                                               ...
                                               <input name="arkaplan" type="text" id="arkaplan"  value="<? echo $arkaplan ?>"  class="form-control" size="55" onBlur="pchange(this, 0);" onFocus="pchange(this, 1);" ></td>
                                              </tr>
                                              ...
                                              <tr>
                                                ...
                                                <img src="<? print($resim_dizini.$resim); ?>"   border="0" style="max-width: 200px;height: auto;"></a></div></td>
                                              </tr>
                                                <? 
                                                        } 
                                                ?>
                                              ...
                                              <tr>
                                                <td height="32">&nbsp;</td>
                                                <td><font class="veri_tarih" style="font-size:10px">Max. Dosya Boyutu: <? print $max_file_size ?> </font></td>
                                              </tr>
                                             <? /*  <tr> 
                                                <td colspan="2">
