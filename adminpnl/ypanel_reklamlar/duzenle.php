...
if (isset($_SESSION['yonet']))
   {
		...
		if  (count($recordset)<>0)
			{	  
				...
				$resim2=$recordset[0]["resim_adres2"];
				$resim3=$recordset[0]["resim_adres3"];
                                ...
                                <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
                                  <td  valign="top" bordercolor="#C0C0C0" bgcolor="#FFFFFF"> 
                                    <table width="100%" border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
                                      <tr>
                                        <td colspan="2" class="anabaslik">Slider Düzenle</td>
                                      </tr>
                                      <tr> 
                                      ...
                                      <tr>
                                        ...
                                        <td bgcolor="#F9F9F9">
                                          ...
                                          <input name="altbilgi" type="text" id="altbilgi"  value="<? echo $altbilgi ?>"class="form-control" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);" >            </td>
                                      </tr>
                                      <? /* */ ?>
                                      <tr>
                                        ...
                                        <td bgcolor="#F9F9F9">
                                          ...
                                          <input name="link" type="text" id="link"  value="<? echo $link ?>"class="form-control" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);" >           </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td bgcolor="#F9F9F9">
                                          ...
                                          <input name="genislik" type="text"class="form-control"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($genislik1)) {echo $genislik1; }?>" size="10" >
                                      ...
                                      <tr>
                                        ...
                                        <td bgcolor="#F9F9F9">
                                          ...
                                          <input name="yukseklik" type="text"class="form-control"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($yukseklik1)) {echo $yukseklik1; }?>" size="10" >
                                      ...
                                      <? /*  
                                                ...
                                                <tr>
                                                  ...
                                                  <td bgcolor="#F9F9F9"><input name="resim2" type="file" id="resim2"class="form-control" onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" size="46">
                                                      <span class="veri_tarih"><a href="<? print($resim_dizini.$resim2); ?>" class="textbox_yardim" target="_blank">(<? print($resim2); ?>)</a></span> </td>
                                      </tr>
                                                
                                                <tr>
                                                  <td><font class="baslik">Logo/Marka  Resim </font></td>
                                                  <td bgcolor="#F9F9F9"><input name="resim3" type="file" id="resim3"class="form-control" onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" size="46">
                                                      <span class="veri_tarih"><a href="<? print($resim_dizini.$resim3); ?>" class="textbox_yardim" target="_blank">(<? print($resim3); ?>)</a></span> </td>
                                      </tr>
