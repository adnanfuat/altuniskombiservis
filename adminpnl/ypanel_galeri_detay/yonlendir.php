...
if (isset($_POST["gizli"]))
   ...
   {
		$sql_cumlesi="select max(numara) from $tablo_ismi where altkategori_no='$altkategori'";
...
for ($sayfa_no=1; $sayfa_no<=$toplam_sayfa_sayisi;$sayfa_no++)
	{
	    ...
	    $sql_cumlesi="select * from $tablo_ismi where altkategori_no='$altkategori' order by puan asc limit $limit_ilk_deger,$bir_sayfadaki_toplam_kayit_sayisi ";
