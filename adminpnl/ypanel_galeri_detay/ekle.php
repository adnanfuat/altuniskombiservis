...
<body class="animsition" onLoad="javascript:document.form1.ad.focus()">
	...
	<a href="kontrol.php" class="veri_ana_baslik">Resimler</a> &gt;</li>
                                        </ul>
                                    </div>
            ...
            <tr> 
              ...
              <td bgcolor="#F9F9F9">
                ...
                <? if (isset($_SESSION[$tablo_ismi.'n_hata'])) 
                        {
                            $hata=$_SESSION[$tablo_ismi.'n_hata'];	if (isset($hata[1]) && $hata[1]==1 ) { echo 'Adını Giriniz';}
                        }
                ?>
                </font>                </td>
            </tr>
                ...
                <? if (isset($_SESSION[$tablo_ismi.'n_hata'])) 
					  {
							...
							if (isset($hata[6]) && $hata[6]==1 ) { echo 'Açıklamasını Giriniz';}
					  }
				?>
              </font>              </td>
            </tr>
