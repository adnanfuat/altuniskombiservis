                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="kontrol.php"  >Referanslar</a> &gt; </li>
                                        </ul>
                                    </div>
    ...
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data" >
      <td  valign="top" bordercolor="#C0C0C0" bgcolor="#FFFFFF" > 
        <table width="100%" border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
          ...
          <tr>
            <td colspan="3">Referans Düzenle</td>
            </tr>
          <tr> 
            <td><font  class="ekle_duzenle_baslik">Adı/Altbilgi * </font></td>
          ...
          <? if (1==1) { ?>
          <tr> 
            <td valign="top"><font class="ekle_duzenle_baslik">Detay  </font></td>
            <td width="66%" bgcolor="#F9F9F9">
            <div align="left">
			<? if (isset($_SESSION[$tablo_ismi.'detay'])) { $detay=$_SESSION[$tablo_ismi.'detay']; } ?>
			<textarea name="detay" cols="54" rows="8" id="detay"  class="form-control"><? echo($detay) ?></textarea>
            </div></td>
           <? if (1==0) { ?>  <td width="17%" bordercolor="#EAEAEA" bgcolor="#F9F9F9"  style="border-style:solid; border-width:1;">              
          ...
          <? } ?>
         <? if (1==1) { ?>  <tr>
            <td><font  class="ekle_duzenle_baslik">Link </font></td>
            <td colspan="2" bgcolor="#F9F9F9">
              <? if (isset($_SESSION[$tablo_ismi.'link'])) { $link=$_SESSION[$tablo_ismi.'link']; } ?>
              <input name="link" type="text" id="link"  value="<? echo $link ?>"  class="form-control" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);" >
              <span class="veri_tarih">Örn:http://www.siteismi.com</span></td>
          </tr><? } ?>
          <tr>
            <td><span class="baslik">Puanı</span></td>
            <td colspan="2" bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'siralama'])) { $siralama=$_SESSION[$tablo_ismi.'siralama']; } ?>
 		    <input name="siralama" type="text"   value="<? echo $siralama ?>"   class="form-control" size="10"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);" >            </td>
          </tr>
          ...
          <tr> 
            ...
            <td colspan="2" bgcolor="#F9F9F9">
              ...
              <span style="font-size:10px"> Boyut: <? echo $k_m_w; ?>px - <? echo $k_m_h; ?>px'in katları olmalıdır.</span></td>
          </tr>
          ...
          <tr>
            <td height="32">&nbsp;</td>
            <td colspan="2"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">Max. Dosya Boyutu:</font></td>
          </tr>
      </table></td>
    </form>
  </tr>
