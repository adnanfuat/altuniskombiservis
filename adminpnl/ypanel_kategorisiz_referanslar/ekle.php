                              ...
                              <td  valign="top" bordercolor="#C0C0C0" bgcolor="#FFFFFF" > 
                                <table  border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
                                  ...
                                  <tr>
                                   ...
                                   <? if (1==1) { ?>
                                  <tr> 
                                    <td valign="top"><font class="baslik">Detay</font></td>
                                    <td bgcolor="#F9F9F9"  >
                                    <div align="left" >
                                    <? if (isset($_SESSION[$tablo_ismi.'n_detay'])) { $detay=$_SESSION[$tablo_ismi.'n_detay']; } ?>
                                    <textarea name="detay" cols="54" rows="8"  class="form-control"><? if (isset($detay)) {echo $detay; }?></textarea>
                                    </div></td>
                                  </tr>
                                  <? } ?>
                                <? if (1==1) { ?>  <tr>
                                    ...
                                    <td bgcolor="#F9F9F9"  >
                                      ...
                                      <input name="link" type="text" class="form-control" id="link"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($link)) {echo $link; }?>" size="55" >
                                  ...
                                  <tr> 
                                    <td><font class="ekle_duzenle_baslik">Resim </font></td>
                                    <td bgcolor="#F9F9F9"  >
                                  ...
                                  <tr>
                                    <td height="32">&nbsp;</td>
                                    <td><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">Max. Dosya Boyutu:</font></td>
                                  </tr>
                              </table></td>
                            </form>
                          </tr>
