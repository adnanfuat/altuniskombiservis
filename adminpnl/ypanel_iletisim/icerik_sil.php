...
$altkategori_resim_sil=@$baglanti->query("Select *  from $tablo_ismi where numara='$numara'")->fetchAll(PDO::FETCH_ASSOC);
...
// (s) Silinecek hizmet kategorisiyle ilgili resim varsa o siliniyor 
$altkategori_icerik_sil="Delete  from $tablo_ismi where numara='$numara'";
