                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                       <i class="fas fa-file-alt"></i> Yeni Sayfa Yönetimi</h3>
                                                                       ...
                                                                       <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="table-data__info">
                                                                                <span><? print(stripslashes($ad)); ?></span>
                                                                                <span> <a href="duzenle.php?numara=<? print($numara);?>"  title="Düzenlemek için Tıklayınız"> <i class="fas fa-edit"></i> </a> </span>
                                                                            </div>
                                                                        </td>
                                                                     <td>
                                                                     <a href="../ypanel_etiket_detay/kontrol.php?haber_no=<? print($numara); ?>" class="veri_baslik">DETAYLAR <i class="fas fa-plus"></i></a>
                                                                     </td>
                                                                      <td>
