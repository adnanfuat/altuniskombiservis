...
if  (isset($_SESSION['yonet']))
    {
		if (isset($_GET["numara"]))
		   {
			  $proje_numara=$_GET["numara"]; // echo $proje_numara;
			  if (isset($_SESSION[$tablo_ismi."proje_numara"])) { unset($_SESSION[$tablo_ismi."proje_numara"]); }
			  $_SESSION[$tablo_ismi."proje_numara"]=$proje_numara;
		   }
		else
		   {
	    ...
	    $sql_cumlesi="select numara from $tablo_ismi where proje_no='$proje_numara'";
	    ...
	    $sql_cumlesi="select * from $tablo_ismi where proje_no='$proje_numara' order by siralama asc,numara asc limit $limit_ilk_deger,$bir_sayfadaki_toplam_kayit_sayisi ";
...
<body class="animsition">
	...
	<a href="../ypanel_proje_detay/kontrol.php" ><? echo $proje_ad; ?></a> &gt;  </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                        <i class="far fa-images"></i> Proje Diğer Resimleri</h3>
                                                                       ...
                                                                       <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="table-data__info">
                                                                                <span><? print($aciklama); ?></span>
                                                                                <span> <a href="duzenle.php?item=<? print($numara);?>"  title="Düzenlemek için Tıklayınız"> <i class="fas fa-edit"></i> </a> </span>                                                                            </div> 
                                                                                
                                                                                <td>
                                                                            <div class="table-data__info">
                                                                           
                    <img src="<? print $thumb_resim_dizini.$resim; ?>?img=<?php echo filemtime($src)?>" height="<? print $yeni_yukseklik; ?>" style="max-width:100px" border="0">                                                                          </div> 
