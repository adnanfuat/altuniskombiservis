...
<body class="animsition" onLoad="document.form1.ad.focus();">
	...
	<a href="kontrol.php" >Ürünler</a> &gt;</font></li>
                                        </ul>
                                    </div>
      ...
      <td  valign="top"> 
          ...
          <table border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
            ...
            <tr> 
              ...
              <input name="ad" type="text" class="form-control" id="ad"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? print(stripslashes($ad)); ?>" size="55" onKeyUp="yoltanimla();">
          ...
          */ ?>  <tr>
              ...
              <td bgcolor="#F9F9F9">
                <? if (isset($_SESSION[$tablo_ismi.'aciklama'])) {$aciklama=$_SESSION[$tablo_ismi.'aciklama']; } ?>
	              <textarea name="aciklama" id="editor" class="<? /* mceAdvanced */ ?>form-control"><? echo stripslashes($aciklama); ?></textarea>
                <font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000">
				<? if (isset($_SESSION[$tablo_ismi.'hata'])) 
                    {
