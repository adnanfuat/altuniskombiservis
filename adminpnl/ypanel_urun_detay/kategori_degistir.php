                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="../ypanel_urun_kategori/kontrol.php" class="veri_ana_baslik">Ürün Kategorileri (<? print $ustkategori_ad; ?>)</a> &gt; 
	<a href="kontrol.php?ust_kategori_no=<? print $ustkategori_no; ?>"  class="veri_ana_baslik">Ürün Alt Kategorileri  </a> &gt; <a href="kontrol.php" class="veri_ana_baslik">Ürünler</a> &gt;</li>
                                        </ul>
                                    </div>
