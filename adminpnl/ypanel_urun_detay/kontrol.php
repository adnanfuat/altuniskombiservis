                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="../ypanel_urun_kategori/kontrol.php" >Ürün Kategorileri (<? print($ustkategori_adi); ?>)</a> &gt;	<a href="../ypanel_urun_altkategori/kontrol.php" >Ürün Alt Kategorileri (<? print($altkategori_adi);?>)</a> &gt;</li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                        <i class="fas fa-boxes"></i>Ürünler</h3>
                                            ...
                                            <thead>
                                                    <tr> 
                                                        <td style="border:0; ">
                                                                ...
                                                                <input name="aktif" type="submit" id="aktif" class="btn btn-danger btn-sm"  value="Aktif" ><br><br>
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr> 
                                                        <td style="border:0; ">
                                                                ...
                                                                <input name="aktif2" type="submit" id="aktif2" class="btn btn-danger btn-sm"  value="Aktif" ><br><br>
