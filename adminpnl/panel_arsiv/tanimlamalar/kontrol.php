...
?>
          <tr> 
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
               <tr>
                 <td colspan="9" class="anabaslik">Tanımlar</td>
               </tr>
			   <? if ($toplam_sayfa_sayisi>0) { ?>
                ...
                <tr> 
                  ...
                  <td colspan="4"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> Ad</strong></font></td>
                  <td colspan="2">&nbsp;</td>
                  <td width="13%">&nbsp;</td>
                </tr>
				<?
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
				  ...
				  <td width="14%" valign="middle"><div align="center"><span class="style10"> <? if (1==2) { ?><a href="../referanslar/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik">REFERANSLAR</a><? } ?></span></div></td>
