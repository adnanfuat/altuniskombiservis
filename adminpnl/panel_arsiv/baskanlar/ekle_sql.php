<?
$banner_ekle=@$baglanti->query("Insert into $tablo_ismi (ad, aktif, puan, sube, adres, telefon, web) Values ('$n_ad', '1', '$n_puan', '$n_sube', '$n_adres', '$n_telefon', '$n_web')")->fetchAll(PDO::FETCH_ASSOC); 
//echo "Insert into $tablo_ismi (ad, aktif, puan, sube, adres, telefon, web) Values ('$n_ad', '1', '$n_puan', '$n_sube', '$n_adres', '$n_telefon', '$n_web')";
