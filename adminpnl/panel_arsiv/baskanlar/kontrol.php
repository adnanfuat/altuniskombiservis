...
if  (isset($_SESSION['yonet']))
    {
		...
		if (isset($_SESSION[$tablo_ismi.'sahip'])) {unset($_SESSION[$tablo_ismi.'sahip']);}
...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    <td width="3%" bgcolor="#FFFFFF" class="td_anabaslik"><div align="center"><img src="../pictures/ana_dok.gif" width="48" height="48"></div></td>
        ...
        ?>
          <tr> 
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  <td colspan="5" class="anabaslik">Şube Başkanları</td>
                </tr>
               <? 
			   ...
			   ?>
                ...
                <tr> 
                  ...
                  <td width="40%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>  Adı </strong></font></td>
                  <td width="43%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> Şube </strong></font></td>
                  <td width="9%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Puan</strong></font></td>
                </tr>
				<?
                for ($sayac=0; $sayac<$toplam_kayit_sayisi; $sayac++)
                    {
                        $ad=$recordset[$sayac]["ad"];
						$sube=$recordset[$sayac]["sube"];
                ...
                <tr  onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
                  ...
                  <td valign="middle" class="veri_baslik"><? print($sube); ?></td>
                  <td valign="middle"><span class="veri_baslik"><? print($puan); ?></span></td>
                </tr>
				<?
                      }
                ?>
