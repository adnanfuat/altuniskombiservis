    ...
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
      <td  valign="top" bordercolor="#C0C0C0" bgcolor="#FFFFFF"> 
        <table width="100%" border="0" align="center" cellpadding="4" cellspacing="6">
          <tr>
            <td colspan="3" class="anabaslik">Başkan Düzenle</td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td><font class="baslik">Şube</font></td>
            <td colspan="2" bgcolor="#F9F9F9">
			<? if (isset($_SESSION[$tablo_ismi.'sube'])) { $sube=$_SESSION[$tablo_ismi.'sube']; } ?>			  
			<input name="sube" type="text" id="sube"  value="<? echo $sube; ?>"  class="textbox1" size="55"  onblur="pchange(this, 0);" onFocus="pchange(this, 1);">            </td>
          </tr>
          
          
          <tr> 
            <td><font class="baslik">Adres</font></td>
            <td colspan="2" bgcolor="#F9F9F9">
			<? if (isset($_SESSION[$tablo_ismi.'adres'])) { $adres=$_SESSION[$tablo_ismi.'adres']; } ?>			  
			<input name="adres" type="text" id="adres"  value="<? echo $adres; ?>"  class="textbox1" size="55"  onblur="pchange(this, 0);" onFocus="pchange(this, 1);">            </td>
          </tr>
          
          
          
          <tr> 
            <td><font class="baslik">Telefon</font></td>
            <td colspan="2" bgcolor="#F9F9F9">
			<? if (isset($_SESSION[$tablo_ismi.'telefon'])) { $telefon=$_SESSION[$tablo_ismi.'telefon']; } ?>			  
			<input name="telefon" type="text" id="telefon"  value="<? echo $telefon; ?>"  class="textbox1" size="55"  onblur="pchange(this, 0);" onFocus="pchange(this, 1);">            </td>
          </tr>
          ...
          <tr> 
            ...
            <td colspan="2" bgcolor="#F9F9F9">
			<? if (isset($_SESSION[$tablo_ismi.'web'])) { $vd=$_SESSION[$tablo_ismi.'web']; } ?>			  
			<input name="web" type="text" id="web"  value="<? echo $web; ?>"  class="textbox1" size="55"  onblur="pchange(this, 0);" onFocus="pchange(this, 1);">            </td>
          </tr>
