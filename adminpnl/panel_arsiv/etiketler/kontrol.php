...
<table width="950" align="center" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
	  ...
	  <tr>
	    <td class="anabaslik">Etiketler</td>
	  </tr>
			<?
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr> 
                  ...
                  <td colspan="3"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Başlık</strong></font></td>
                  <td colspan="3">&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'" bgcolor="<? echo $tr_back; ?>"> 
                  ...
                  <td width="35%" height="30" valign="middle"><font class="veri_baslik"><? echo stripslashes($ad); ?></font></td>
 ...
 <td width="6%" align="center" valign="middle"><? if ($resim!='resimyok.gif' && file_exists($resim_dizini.$resim)) { if ($uzanti=="jpeg" || $uzanti=="jpg" || $uzanti=="gif") { ?>
                 ...
                 <? /* <div align="center">
                  <a href="../Etiket_detay/kontrol.php?haber_no=<? print($numara); ?>"><font class="altkategori">Etiket Detay</font></a></div>
                  */ ?> 
                  </td>
				</tr>
				<?
