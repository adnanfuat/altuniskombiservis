...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    <td width="50" class="td_anabaslik"><img src="../pictures/mailgrub.gif" width="48" height="48"></td>
...
<table width="950" align="center" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
	  ...
	  <tr>
	    <td class="anabaslik">İletişim</td>
	  </tr>
			<?
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr> 
                  ...
                  <td colspan="3"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>İletişim  Başlığı</strong></font></td>
                  <td colspan="3">&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
 ...
 <td width="6%" align="center" valign="middle"><? if ($resim!='resimyok.gif' && file_exists($resim_dizini.$resim)) { if ($uzanti=="jpeg" || $uzanti=="jpg" || $uzanti=="gif") { ?>
                ...
                <? if (1==2) { ?>  <a href="../hakkinda_detay/kontrol.php?haber_no=<? print($numara); ?>"><font class="altkategori">HAKKINDA DETAY</font></a> <? } ?></div></td>
				</tr>
				<?
					  }
				?>
