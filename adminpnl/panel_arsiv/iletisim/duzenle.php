...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    <td width="48" class="td_anabaslik"><div align="left"><img src="../pictures/mailgrub.gif" width="48" height="48"></div></td>
    <td width="890" class="td_anabaslik">
	<span class="veri_ana_baslik"><a href="../anaframe.php" class="veri_ana_baslik">Kontrol Panel</a> &gt;
	<a href="kontrol.php" class="veri_ana_baslik">İletişim</a> &gt;</span></td>
  </tr>
</table>
    ...
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
        <table width="942" border="0" align="center" cellpadding="4" cellspacing="6">
          <tr>
            <td colspan="3" class="anabaslik">İletişim Düzenle</td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td><strong class="baslik">İletişim Başlığı * </strong></td>
     ...
     <? if (1==2) { ?>     <tr>
            <td valign="middle"><strong class="baslik">İletişim  Özet *</strong></td>
            <td colspan="2" bgcolor="#F9F9F9">
