...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    <td width="48" class="td_anabaslik"><div align="left"><img src="../pictures/mailgrub.gif" alt="" width="48" height="48"></div></td>
    ...
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
        <table width="942" border="0" align="center" cellpadding="4" cellspacing="6">
          <tr>
            <td colspan="3" class="anabaslik">İletişim Ekle</td>
          </tr>
          <tr> 
            <td></td>
            <td colspan="2">
          ...
          <tr> 
            <td width="184"><strong class="baslik">İletişim  Başlığı *</strong></td>
