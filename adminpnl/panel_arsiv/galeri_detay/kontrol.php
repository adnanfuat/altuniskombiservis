...
if (isset($_SESSION['yonet']))
   {
	 ...
	 //$syonetim=$_SESSION["siteyonetici"];
	  ...
	  $ustkategori_adi=$ustkategori_adi_ogren[0]["ad"];// echo  $ustkategori_adi;
	  $altkategori_adi_ogren=@$baglanti->query("Select ad from $altkategori_tablo_adi where numara=".$altkategori)->fetchAll(PDO::FETCH_ASSOC); // echo "Select ad from $altkategori_tablo_adi where numara=".$altkategori;
	  $altkategori_adi=$altkategori_adi_ogren[0]["ad"];// echo "vvv".$altkategori_adi;
          ...
          <tr> 
            <td width="944"><table width="944" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr>
                  ...
                  <td>&nbsp;</td>
                  <td width="70"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><span class="style3">Puan</span></font></td>
                  <td width="56">&nbsp;</td>
                  <td width="60">&nbsp;</td>
                  <td width="64">&nbsp;</td>
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'" bgcolor="<? echo $tr_back; ?>">
                  ...
                  <td><? if (1==2) { ?><div align="center"><a href="../urunresim/kontrol.php?numara=<? print($numara);?>" class="resim_sil"> DİĞER<br> 
                  RESİMLERİ</a></div> <? } ?></td>
