		...
		for ($sayac=1; $sayac<=20; $sayac++)
			{
				...
				$n_htaccess_etiket=$_POST["htaccess_etiket".$sayac.""];
				if (strlen(trim($n_ad))>0)
				   {
						$ekle_duzenle_sql="Insert into $tablo_ismi(ustkategori_no, ad, altkategori_no, aktif, eklenme_tarihi, puan, hit, aciklama, htaccess_etiket) 
													Values ('$ustkategori_no', '$n_ad', '$altkategori', '1', '$n_tarih', '$n_puan', '0', '','$n_htaccess_etiket')";
