...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    <td width="48" class="td_anabaslik"><div align="right"><img src="../pictures/duyurular.gif" width="48" height="48"></div></td>
 ...
 ?>
          <tr> 
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                <tr><td colspan="4" class="anabaslik">Hasar Bildirim Bilgileri</td>
                </tr>
                ...
                <tr> 
                  ...
                  <td colspan="2"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> <? echo $kategori ?></strong></font></td>
                </tr>
				<?
                ...
                <tr> 
                  ...
                  <td width="77%" height="30" valign="middle" bgcolor="#F7F7F7"><font>&nbsp;<img src="<? print $uzaklik; ?>rsmlr/gri_nokta.gif" width="12" height="12" align="absmiddle"> 
				  <strong>
				  <a href="duzenle.php?numara=<? print($numara);?>"   class="veri_baslik" title="Duyuruyu Düzenlemek İçin Tıklayınız"><? print($ad); ?></a></strong></font> </td>
                  <td width="13%" align="center" valign="middle" bgcolor="#F7F7F7"><font class="veri_baslik"><strong><? print($dil_aciklama); ?> </strong></font></td>
                </tr>
				<?
					  }
				?>
