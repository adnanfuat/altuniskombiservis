...
if (isset($_SESSION['yonet']))
   {
		...
		$sql="Select ad,numara from  $tablo_ismi where ustkategori_no='$ustkategori_no'";
						...
						for ($sayac=0; $sayac<$kayit_sayisi; $sayac++)
							{
								...
								if  (isset($altkategori[$altkategori_no]))   
								    {
										$alt_kategori_guncelle="Update $tablo_ismi set ustkategori_no=$yeni_ust_kategori_no where numara=$altkategori_no";
