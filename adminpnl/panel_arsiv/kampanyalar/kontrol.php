...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    <td width="50" class="td_anabaslik"><img src="../pictures/haber.gif" width="48" height="48"></td>
...
<table width="950" align="center" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
	  ...
	  <tr><td class="anabaslik">Etkinlikler</td></tr>
			<?
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr> 
                  ...
                  <td colspan="3"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> Başlığı</strong></font></td>
                  <td colspan="3">&nbsp;</td>
                  <td>&nbsp;</td>
                  <td><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>AS Resmi</strong></font></td>
                </tr>
				...
				for  ($sayac=0; $sayac<$toplam_kayit_sayisi; $sayac++)
					 {
						...
						$icon=$recordset[$sayac]["icon_adres"];
 ...
 <td width="6%" align="center" valign="middle"><? if ($resim!='resimyok.gif' && file_exists($resim_dizini.$resim)) { if ($uzanti=="jpeg" || $uzanti=="jpg" || $uzanti=="gif") { ?>
                 ...
                 <? /* 
				  <div align="center">
                  	<a href="../haber_detay/kontrol.php?haber_no=<? print($numara); ?>"><font class="altkategori">HABER DETAY</font></a>
				  </div> 
                  */ ?>
                  ...
                  <div align="center">
                    ...
                    <?
					if  ($icon=='') {$icon=$default_resim; }
					if  ($icon<>$default_resim) 
					    { 
					?> 
                    <a href="<? print($thumb_resim_dizini.$icon); ?>" target="_blank"><img src="../../rsmlr/tel.png" width="29" height="29" border="0"></a>
                    <? 
						} 
					?>
				  </div> 
