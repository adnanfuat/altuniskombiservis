...
if (isset($_SESSION['yonet']))
   {
		...
		if  (count($recordset)<>0)
			{	  
				...
				$yeni_fiyat=stripslashes($recordset[0]["yeni_fiyat"]);
				$eski_fiyat=stripslashes($recordset[0]["eski_fiyat"]);
    ...
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
        <table width="942" border="0" align="center" cellpadding="4" cellspacing="6">
          ...
          <tr> 
            <td><strong class="baslik">Başlığı * </strong></td>
          ...
          <tr> 
            <td width="184"><strong class="baslik">Tarihi</strong></td>
            <td colspan="2" bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'eski_fiyat'])) { $eski_fiyat=$_SESSION[$tablo_ismi.'eski_fiyat']; } ?>
			<input name="eski_fiyat" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($eski_fiyat)) {echo $eski_fiyat; }?>" size="55" >
            </td>
          </tr>
          
        <? /*   <tr> 
            <td width="184"><strong class="baslik">Kampanya Yeni Fiyatı</strong></td>
            <td colspan="2" bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'yeni_fiyat'])) { $yeni_fiyat=$_SESSION[$tablo_ismi.'yeni_fiyat']; } ?>
			<input name="yeni_fiyat" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($yeni_fiyat)) {echo $yeni_fiyat; }?>" size="55" >
            </td>
          </tr>  */ ?>
         ...
         <? if (1==2) { ?> <tr>
            <td valign="middle"><strong class="baslik">Haber Özet *</strong></td>
            <td colspan="2" bgcolor="#F9F9F9">
          ...
          <tr> 
            <td><strong class="baslik">Ana Sayfadaki Resmi</strong></td>
            <td width="522" bgcolor="#F9F9F9">
            <input name="icon" type="file" id="resim"  class="textbox1" onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" size="46">
            <span class="veri_tarih">Tavsiye Edilen: 273px * 371 px</span></td>
