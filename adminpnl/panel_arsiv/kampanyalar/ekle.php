    ...
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
        <table width="942" border="0" align="center" cellpadding="4" cellspacing="6">
          ...
          <tr> 
            <td width="184"><strong class="baslik">Başlığı *</strong></td>
          ...
          <tr> 
            ...
            <td colspan="2" bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'n_eski_fiyat'])) { $eski_fiyat=$_SESSION[$tablo_ismi.'n_eski_fiyat']; } ?>
			<input name="eski_fiyat" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($eski_fiyat)) {echo stripslashes($eski_fiyat); }?>" size="55" >
            </td>
          </tr>
      ...
      <? /*     <tr> 
            ...
            <td colspan="2" bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'n_yeni_fiyat'])) { $yeni_fiyat=$_SESSION[$tablo_ismi.'n_yeni_fiyat']; } ?>
         ...
         <? if (1==2) { ?>  <tr>
          ...
          <tr> 
            ...
            <td width="529" bgcolor="#F9F9F9">
              <input name="icon" type="file" class="textbox1" onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" size="46">
