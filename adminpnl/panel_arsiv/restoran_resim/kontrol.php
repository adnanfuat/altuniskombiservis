...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    ...
    <td width="97%" class="td_anabaslik"><font class="veri_ana_baslik"><a href="../anaframe.php" class="veri_ana_baslik">Kontrol Panel</a> &gt; <a href="../restoran_kategori/kontrol.php" class="veri_ana_baslik">Restoranlar (<? echo $hizmet_ad; ?>)</a> &gt; </font>
    </td>
  </tr>
</table>
  ...
  <tr> 
    <form  name="xxxy" action="kontrol_islem.php" method="post">
      <td  align="center" valign="top">
          ...
          <tr>
            <td width="944" class="anabaslik">Restoran Resimleri</td>
          </tr>
          <tr> 
            <td>
