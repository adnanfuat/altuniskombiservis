  		...
  		if (isset($err))
		   {
				...
				$_SESSION[$tablo_ismi.'ay']=$ay;
				$_SESSION[$tablo_ismi.'etkinliktarihi']=$etkinliktarihi;
				$_SESSION[$tablo_ismi.'gun']=$gun;
				$_SESSION[$tablo_ismi.'saat']=$saat;
		...
		else
	        {
				...
				unset($_SESSION[$tablo_ismi.'ay']);
				unset($_SESSION[$tablo_ismi.'etkinliktarihi']);
				unset($_SESSION[$tablo_ismi.'gun']);
				unset($_SESSION[$tablo_ismi.'saat']);
