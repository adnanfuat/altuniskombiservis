...
if (isset($_SESSION['yonet']))
   {
		...
		if  (count($recordset)<>0)
			{	  
				...
				$etkinliktarihi=$recordset[0]["etkinliktarihi"];
				$gun=$recordset[0]["gun"];
				$saat=$recordset[0]["saat"];
				...
				switch ($ay)
					{		
						case 1: $ay_aciklama="Ocak"; break;
						case 2: $ay_aciklama="Şubat"; break;
						case 3: $ay_aciklama="Mart"; break;
						case 4: $ay_aciklama="Nisan"; break;
						case 5: $ay_aciklama="Mayıs"; break;
						case 6: $ay_aciklama="Haziran"; break;
						case 7: $ay_aciklama="Temmuz"; break;
						case 8: $ay_aciklama="Ağustos"; break;
						case 9: $ay_aciklama="Eylül"; break;
						case 10: $ay_aciklama="Ekim"; break;
						case 11: $ay_aciklama="Kasım"; break;
						case 12: $ay_aciklama="Aralık"; break;
					}				
    ...
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
        <table width="942" border="0" align="center" cellpadding="4" cellspacing="6">
          <tr>
            <td colspan="3" class="anabaslik">Etkinlik Düzenle</td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td><strong class="baslik">Etkinlik Başlığı * </strong></td>
          ...
          <tr> 
           ...
           <input name="htaccess_etiket" type="text" id="htaccess_etiket"  value="<? echo $htaccess_etiket ?>"  class="textbox1" size="55" onBlur="pchange(this, 0);" onFocus="pchange(this, 1);"> <span class="veri_baslik">* Eğer Htaccess Etiket kısmında özel karakterler var ise kaldırmalısınız ( ! , ? , + , % , & , ' , . , $ , # , * , ; , , , )  vs. gibi</span></td>
          </tr>
          <tr>
         ...
         <tr>
            <td><span class="baslik"><strong>Ay</strong></span></td>
            <td colspan="2" bgcolor="#F9F9F9"><? if (isset($_SESSION[$tablo_ismi.'ay'])) { $ay=$_SESSION[$tablo_ismi.'ay']; } ?>
          ...
          <tr> 
            <td><strong class="baslik">Tarih</strong></td>
            <td colspan="2" bgcolor="#F9F9F9">
			<? if (isset($_SESSION[$tablo_ismi.'etkinliktarihi'])) { $etkinliktarihi=$_SESSION[$tablo_ismi.'etkinliktarihi']; } ?>			  
			<input name="etkinliktarihi" type="text" id="etkinliktarihi"  value="<?  echo $etkinliktarihi; ?>"  class="textbox1" size="55"  onblur="pchange(this, 0);" onFocus="pchange(this, 1);">           </td>
          </tr>
          

          <tr> 
            <td><strong class="baslik">Gün</strong></td>
            <td colspan="2" bgcolor="#F9F9F9">
			<? if (isset($_SESSION[$tablo_ismi.'gun'])) { $gun=$_SESSION[$tablo_ismi.'gun']; } ?>			  
			<input name="gun" type="text" id="gun"  value="<?  echo $gun; ?>"  class="textbox1" size="55"  onblur="pchange(this, 0);" onFocus="pchange(this, 1);">           </td>
          </tr>
  
            <tr> 
            <td><strong class="baslik">Saat</strong></td>
            <td colspan="2" bgcolor="#F9F9F9">
			<? if (isset($_SESSION[$tablo_ismi.'saat'])) { $saat=$_SESSION[$tablo_ismi.'saat']; } ?>			  
			<input name="saat" type="text" id="saat"  value="<?  echo $saat; ?>"  class="textbox1" size="55"  onblur="pchange(this, 0);" onFocus="pchange(this, 1);">           </td>
          </tr>
