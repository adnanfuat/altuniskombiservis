...
$altkategori_resim_sil=@$baglanti->query("Select resim_adres,numara  from $altkategori_tablo_ismi where haber_no=$numara")->fetchAll(PDO::FETCH_ASSOC);
...
// (s) Silinecek hizmet kategorisiyle ilgili resim varsa o siliniyor 
$altkategori_icerik_sil="Delete  from $altkategori_tablo_ismi where haber_no=$numara";
