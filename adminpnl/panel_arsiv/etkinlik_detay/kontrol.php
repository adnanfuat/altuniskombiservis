...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    <td width="50" class="td_anabaslik"><div align="center"><img src="../pictures/calendar.jpg" width="48" height="48"></div></td>
	...
	<a href="../etkinlikler/kontrol.php" class="veri_ana_baslik">Etkinlikler (<? echo $haber_adi; ?>)</a> &gt;</font></td>
  </tr>
</table>
...
<tr> 
	...
	<table width="942" border="0" cellpadding="0" cellspacing="0">
     <tr><td class="anabaslik">Etkinlik Detayları</td></tr>
	<?
		  ...
		  <tr> 
            <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr>
                  ...
                  <td width="60%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Detaylar</strong></font></td>
                  <td width="8%">&nbsp;</td>
                  <td colspan="3">&nbsp;</td>
                  <td width="8%">&nbsp;</td>
                </tr>
