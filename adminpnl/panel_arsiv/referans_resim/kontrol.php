  ...
  if  (isset($_SESSION['yonet']))
	  {
	  	...
	  	if (isset($_GET["numara"]))
		   {
			  $hizmet=$_GET["numara"]; //echo $hizmet."aa";
			  if (isset($_SESSION[$tablo_ismi."hizmet"])) 
			  { unset($_SESSION[$tablo_ismi."hizmet"]); }
		...
		$hizmet_ogren=@$baglanti->query("Select ad from referanslar where numara='$hizmet'")->fetchAll(PDO::FETCH_ASSOC);
...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    ...
    <td width="97%" class="td_anabaslik"><font class="veri_ana_baslik"><a href="../anaframe.php" class="veri_ana_baslik">Kontrol Panel</a> &gt; <a href="../kategorisiz_referanslar/kontrol.php" class="veri_ana_baslik">Referanslar (<? echo $hizmet_ad; ?>)</a> &gt; </font>
    </td>
  </tr>
</table>
  ...
  <tr> 
    <form  name="xxxy" action="kontrol_islem.php" method="post">
      <td  align="center" valign="top">
          ...
          <tr>
            <td width="944" class="anabaslik">Referans Resimleri</td>
          </tr>
          <tr> 
            <td>
            ...
            ?>
			 ...
			 ?>
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"  bgcolor="<? echo $tr_back; ?>">
                  ...
                  <td>
                    <div align="center">
				    <span class="veri_baslik"><img src="<? print $thumb_resim_dizini.$resim; ?>" height="<? print $yeni_yukseklik; ?>" width="<? print $yeni_genislik ?>" border="0"></span></div></td>
