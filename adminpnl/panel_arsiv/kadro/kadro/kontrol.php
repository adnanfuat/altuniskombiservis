...
if (isset($_SESSION['yonet']))
   {
		...
		if (isset($_SESSION[$tablo_ismi.'meslek'])) {unset($_SESSION[$tablo_ismi.'meslek']);}
		if (isset($_SESSION[$tablo_ismi.'pozisyon'])) {unset($_SESSION[$tablo_ismi.'pozisyon']);}
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                ...
                <tr> 
                  ...
                  <td width="29%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Pozisyon</strong></font></td>
                  <td width="6%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Puan</strong></font></td>
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
                  ...
                  <td height="30" valign="middle"  class="veri_baslik"><? echo $pozisyon; ?></td>
                  <td height="30" valign="middle"  class="veri_baslik"><? echo $puan; ?></td>
