...
?>
             ...
             <? /*  <td colspan="3"><img src="<? echo $uzaklik; ?>rsmlr/next.gif" width="6" height="9">
                  <font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> Diğer Resimler </strong></font></td>  */ ?>
                  <td width="4%">
                  <font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Puan </strong></font>
                  </td>
                  <td width="16%"></td>
                </tr>
				<?
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
                 ...
                 <? /*  <td width="23%" valign="middle" ><font class="veri_detay"><strong><a href="../referans_resim/kontrol.php?numara=<? print($numara);?>" class="linkler">RESİMLER</a></strong></font> </td> */ ?>
