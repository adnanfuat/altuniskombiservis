...
?>
          <tr> 
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
               <tr>
                 <td colspan="9" class="anabaslik">Referans Kategorileri</td>
               </tr>
			   <? if ($toplam_sayfa_sayisi>0) { ?>
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
				  ...
				  <td width="14%" valign="middle"><div align="center"><span class="style10"> <a href="../referanslar/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik">REFERANS DETAYLARI</a></span></div></td>
