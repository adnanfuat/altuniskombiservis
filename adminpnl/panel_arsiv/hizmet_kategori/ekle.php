...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    ...
    <a href="kontrol.php"  class="veri_ana_baslik">Hizmetler</a> &gt;</font></td>
  </tr>
</table>
        ...
        <table width="944" border="0" align="center" cellpadding="4" cellspacing="6">
          ...
          <tr> 
            ...
            <td bgcolor="#F9F9F9">
			  ...
			  <input name="gorsel" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($gorsel)) {echo $gorsel; }?>" size="55">         </td>
          </tr>
          <tr> 
            ...
            <td bgcolor="#F9F9F9">
			  ...
			  <input name="referans" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($referans)) {echo $referans; }?>" size="55">            </td>
          </tr>
          <? } ?>
        ...
        <? if (1==2) { ?>  <tr>
          ...
          <tr>
			...
			<? if (isset($_SESSION[$tablo_ismi.'n_ozet'])) { $ozet=$_SESSION[$tablo_ismi.'n_ozet']; } ?>
              <textarea name="ozet" cols="55" rows="5" class="textbox1" id="ozet"><? echo stripslashes($ozet); ?></textarea>            </td>
          </tr>
          <tr>
