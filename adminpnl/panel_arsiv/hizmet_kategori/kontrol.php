  ...
  <tr> 
     <form  name="xxx" action="kontrol_islem.php" method="post">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr><td class="anabaslik">Hizmetler</td></tr>
         <?
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
                  ...
                  <td width="29%" valign="middle" ><font class="veri_baslik"><? echo stripslashes($ad); ?></font></td>
...
<? print($hizmetkategori_aciklama); ?></font></td>
				  <td width="12%" valign="middle"><? if (1==2) { ?><div align="center"><a href="../hizmet_icon/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik"><strong>SLİDE RESİM</strong></a></div><? } ?></td>
                  <td width="12%" valign="middle"><div align="center"><a href="../hizmet_resim/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik"><strong>İlişkili Hizmetler</strong></a></div></td>
                  <? 
