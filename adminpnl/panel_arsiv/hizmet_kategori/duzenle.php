      ...
      <td valign="top"> 
       ...
       <tr><td colspan="3" class="anabaslik">Hizmet  Düzenle</td>
          ...
          <tr> 
            ...
            <input name="gorsel" type="text" id="gorsel"  value="<? echo $gorsel ?>"  class="textbox1" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);" >            </td>
          </tr>
          <tr> 
            ...
            <input name="referans" type="text" id="referans"  value="<? echo $referans ?>"  class="textbox1" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);">            </td>
          </tr>
          <? } ?>
      <tr>
