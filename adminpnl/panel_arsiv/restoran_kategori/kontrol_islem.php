	 ...
	 if  (isset($_GET["item"])) 
		...
		if  (isset($_POST["ekle"]) || isset($_POST["ekle2"]))   
			{    
				...
				if (isset($_SESSION[$tablo_ismi.'n_hizmetkategori'])) {unset($_SESSION[$tablo_ismi.'n_hizmetkategori']);}
				if (isset($_SESSION[$tablo_ismi.'n_dil'])) {unset($_SESSION[$tablo_ismi.'n_dil']);}
				if (isset($_SESSION[$tablo_ismi.'n_htaccess_etiket'])) {unset($_SESSION[$tablo_ismi.'n_htaccess_etiket']);}
				if (isset($_SESSION[$tablo_ismi.'n_radyo'])) {unset($_SESSION[$tablo_ismi.'n_radyo']);}
