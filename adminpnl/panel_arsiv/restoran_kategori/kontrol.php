  ...
  <tr> 
     <form  name="xxx" action="kontrol_islem.php" method="post">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td class="anabaslik">Restoranlar</td>
		</tr>
         <?
...
<? print($hizmetkategori_aciklama); ?></font></td>
				  <td width="12%" valign="middle"><? if (1==2) { ?>
				  <div align="center"><a href="../hizmet_icon/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik"><strong>SLIDE RESİM</strong></a></div><? } ?></td>
                  <td width="12%" valign="middle"><div align="center"><a href="../restoran_resim/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik"><strong>SLIDE RESİM</strong></a></div></td>
                  <? 
