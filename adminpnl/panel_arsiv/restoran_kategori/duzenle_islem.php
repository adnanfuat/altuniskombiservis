...
if (isset($_SESSION['yonet']))
   {
	  ...
	  $aciklama=addslashes($_POST["aciklama"]); // icerik 1
	  $baslik2=$_POST["baslik2"];
	  $ozet=addslashes($_POST["ozet"]); // icerik 2
	  $renk=$_POST["renk"];
	  $link=$_POST["link"];
	  $insta_baslik=$_POST["insta_baslik"];
	  $insta_token=$_POST["insta_token"];
	  $hizmetkategori=$_POST["hizmetkategori"];
	  $htaccess_etiket=$_POST["htaccess_etiket"];
	  $puan=$_POST["puan"];
	  $dil=$_POST["dil"];
	  $radiobutton=$_POST["radyo"];
		...
		if (isset($err))
		   {
			    ...
			    $_SESSION[$tablo_ismi.'gorsel']=$gorsel;
			    $_SESSION[$tablo_ismi.'baslik1']=$baslik1;
			    $_SESSION[$tablo_ismi.'aciklama']=$aciklama;
			    $_SESSION[$tablo_ismi.'baslik2']=$baslik2;
			    $_SESSION[$tablo_ismi.'ozet']=$ozet;
			    $_SESSION[$tablo_ismi.'renk']=$renk;
			    $_SESSION[$tablo_ismi.'link']=$link;
			    $_SESSION[$tablo_ismi.'insta_baslik']=$insta_baslik;
			    $_SESSION[$tablo_ismi.'insta_token']=$insta_token;
			    ...
			    $_SESSION[$tablo_ismi.'radyo']=$radiobutton;
	  ...
	  else
		  {
			    ...
			    if (isset($_SESSION[$tablo_ismi.'gorsel'])) {unset($_SESSION[$tablo_ismi.'gorsel']);}
				if (isset($_SESSION[$tablo_ismi.'baslik1'])) {unset($_SESSION[$tablo_ismi.'baslik1']);}
			    if (isset($_SESSION[$tablo_ismi.'aciklama'])) {unset($_SESSION[$tablo_ismi.'aciklama']);}
			    if (isset($_SESSION[$tablo_ismi.'baslik2'])) {unset($_SESSION[$tablo_ismi.'baslik2']);}
				if (isset($_SESSION[$tablo_ismi.'ozet'])) {unset($_SESSION[$tablo_ismi.'ozet']);}
			    if (isset($_SESSION[$tablo_ismi.'renk'])) {unset($_SESSION[$tablo_ismi.'renk']);}
			    if (isset($_SESSION[$tablo_ismi.'link'])) {unset($_SESSION[$tablo_ismi.'link']);}
				if (isset($_SESSION[$tablo_ismi.'insta_baslik'])) {unset($_SESSION[$tablo_ismi.'insta_baslik']);}
			    if (isset($_SESSION[$tablo_ismi.'insta_token'])) {unset($_SESSION[$tablo_ismi.'insta_token']);}
