...
if (isset($_SESSION['yonet']))
   {
		...
		if  (count($recordset)<>0)
			{	  
				...
				$baslik1=$recordset[0]["baslik1"];
				$baslik2=$recordset[0]["baslik2"];
				$gorsel=$recordset[0]["gorsel"];
				$aciklama=$recordset[0]["aciklama"];
				$dil=$recordset[0]["dil"];
				$renk=$recordset[0]["renk"];
				$insta_baslik=$recordset[0]["insta_baslik"];
				$insta_token=$recordset[0]["insta_token"];
  ...
  <tr> 
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
       ...
       <tr>
         <td colspan="3" class="anabaslik">Restoran  Düzenle</td>
       </tr>
          <tr> 
          ...
          <tr> 
            <td><strong class="baslik">Manşet  Linki </strong></td>
            <td colspan="2" bgcolor="#F9F9F9">
			<? if (isset($_SESSION[$tablo_ismi.'gorsel'])) { $gorsel=$_SESSION[$tablo_ismi.'gorsel']; } ?>			  
            <input name="gorsel" type="text" id="gorsel"  value="<? echo $gorsel ?>"  class="textbox1" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);" >
          ...
          <tr>
            <td class="baslik"><span class="baslik"><strong>Başlık 1 *</strong></span></td>
            <td colspan="2" bgcolor="#F9F9F9"> <? if (isset($_SESSION[$tablo_ismi.'n_baslik1'])) { $baslik1=$_SESSION[$tablo_ismi.'n_baslik1']; } ?>
			  <input name="baslik1" type="text"  class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<?    echo  stripslashes($baslik1); ?>" size="55"></td>
          </tr>
          <tr>
            <td class="baslik">İçerik 1</td>
            <td colspan="2" bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'aciklama'])) { $aciklama=$_SESSION[$tablo_ismi.'aciklama']; } ?>
            <textarea name="aciklama" cols="80" rows="25" class="mceAdvanced"><? echo stripslashes($aciklama); ?></textarea>            </td>
          </tr>
          
          <tr>
            <td class="baslik"><span class="baslik"><strong>Başlık 2 *</strong></span></td>
            <td colspan="2" bgcolor="#F9F9F9"> <? if (isset($_SESSION[$tablo_ismi.'n_baslik2'])) { $baslik2=$_SESSION[$tablo_ismi.'n_baslik2']; } ?>
            <input name="baslik2" type="text"  class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<?  echo  stripslashes($baslik2); ?>" size="55"></td>
          </tr>
          
          <tr>
            <td class="baslik">İçerik 2 *</td>
            <td colspan="2" bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'ozet'])) { $ozet=$_SESSION[$tablo_ismi.'ozet']; } ?>
            <textarea name="ozet"  cols="80" rows="25" class="mceAdvanced" id="ozet"><? echo stripslashes($ozet); ?></textarea>            </td>
          </tr>
          
          
          
          <tr>
            <td><strong class="baslik">Tema Renk Kodu</strong></td>
            <td colspan="2" bgcolor="#F9F9F9">
            
            	<? if (isset($_SESSION[$tablo_ismi.'n_renk'])) { $renk=$_SESSION[$tablo_ismi.'n_renk']; } ?>
			    <input name="renk" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<?  echo $renk; ?>" size="55">            </td>
          </tr>
          ...
          <tr> 
            ...
            <td bgcolor="#F9F9F9" colspan="3">
			  ...
			  <input name="link" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<?  echo $link; ?>" size="55">
              <br>
              <span class="veri_tarih">* Bu alan restoran sayfasının menüsü için kullanacağınız  linke aittir. Bunun için dosya yükleme modülünden menüyü yükleyip, buraya linkini girin.</span>
            </td>
          </tr>
          ...
          <tr> 
            ...
            <td bgcolor="#F9F9F9" colspan="3">
			  ...
			  <input name="insta_baslik" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<?   echo $insta_baslik;  ?>" size="55">               </td>
          </tr>
          <tr> 
            ...
            <td bgcolor="#F9F9F9" colspan="3">
			  ...
			  <input name="insta_token" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? echo $insta_token; ?>" size="55">            </td>
          </tr>
          <tr> 
            <td height="32">&nbsp;</td>
            <td colspan="2">
