...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
	...
	<a href="../proje_kategori/kontrol.php" class="veri_ana_baslik">Proje Kategorileri (<? echo $kategori_ad; ?>)</a> &gt;
	<a href="../proje_altkategori/kontrol.php" class="veri_ana_baslik">Proje Alt Kategorileri (<? echo $altkategori_ad; ?>)</a> &gt; 
	<a href="../proje_detay/kontrol.php"  class="veri_ana_baslik"><? echo $proje_ad; ?></a> &gt;	
	<a href="kontrol.php"  class="veri_ana_baslik">Proje Resimleri </a> &gt;</font>    
    </td>
  </tr>
</table>
...
<tr> 
     <form  name="xxxy" action="kontrol_islem.php" method="post">
      ...
      <tr>
          <td class="anabaslik">Proje Resimleri</td>
      </tr>
 <?
