  ...
  if  (isset($_SESSION['yonet']))
	  {
		...
		$hizmet_ogren=@$baglanti->query("Select ad from sss_kategori where numara='$hizmet'")->fetchAll(PDO::FETCH_ASSOC);
...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    <td width="3%" class="td_anabaslik"><div align="center"><img src="../pictures/baskanlik.gif" width="48" height="48"></div></td>
    <td width="97%" class="td_anabaslik"><font class="veri_ana_baslik"><a href="../anaframe.php" class="veri_ana_baslik">Kontrol Panel</a> &gt; <a href="../sss_kategori/kontrol.php" class="veri_ana_baslik">S.S.S: Kategorileri (<? echo $hizmet_ad; ?>)</a> &gt; </font>
    </td>
  </tr>
</table>
  ...
  <tr> 
    <form  name="xxxy" action="kontrol_islem.php" method="post">
      <td  align="center" valign="top">
          ...
          <tr>
            <td width="944" class="anabaslik">S.S.S. Detayları</td>
          </tr>
          <tr> 
            <td>
            ...
            ?>
			 ...
			 ?>
                ...
                <tr> 
                  ...
                  <td width="25%"><div align="center"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Soru</strong></font></div></td>
                  <td width="25%"><div align="center"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Cevap</strong></font></div></td>
                   ...
                   for   ($sayac=0; $sayac<$toplam_kayit_sayisi; $sayac++)
                         {
							...
							if  (strlen($aciklama)>200){ $aciklama=substr($aciklama,0,200)."..."; } else { $aciklama=$aciklama; } 
                ?>
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"  bgcolor="<? echo $tr_back; ?>">
                  ...
                  <td class="veri_detay"><div align="center"><? echo $ad; ?></div></td>
                  <td align="center" class="veri_detay"><? echo $aciklama; ?></td>
