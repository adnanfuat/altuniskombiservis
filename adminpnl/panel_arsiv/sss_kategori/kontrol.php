  ...
  <tr> 
     <form  name="xxx" action="kontrol_islem.php" method="post">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td class="anabaslik">Sıkça Sorulan Sorular</td>
		</tr>
         <?
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
                  ...
                  <td width="37%" valign="middle" ><font class="veri_baslik"><? print($ad); ?></font></td>
                  <td width="6%" valign="middle" ><font class="veri_baslik"><? print($puan); ?></font></td>
                  <td width="7%" align="center" valign="middle" ><font class="veri_baslik"><strong><? print($dil_aciklama); ?> </strong><br>
<? print($hizmetkategori_aciklama); ?></font></td>
                  <td width="12%" valign="middle"><div align="center"><a href="../sss_detay/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik"><strong>DETAYLAR</strong></a></div></td>
                  <? 
