		...
		for ($sayac=1; $sayac<=20; $sayac++)
			{
			    ...
			    if  (strlen(trim($n_ad))>0)
				    {
						$ekle_duzenle_sql="Insert into $tablo_ismi(ustkategori_no, ad, altkategori_no, aktif, eklenme_tarihi, puan, hit, aciklama, fiyat) 
										Values ('$ustkategori_no', '$n_ad', '$altkategori', '1', '$n_tarih', '$n_puan', '0', '', '$n_fiyat')";
