...
<table width="950" align="center" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
	  ...
	  <tr>
	    <td class="anabaslik">Acenteler</td>
	  </tr>
			<?
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr> 
                  ...
                  <td><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Başlık</strong></font></td>
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'" bgcolor="<? echo $tr_back; ?>"> 
                  ...
                  <td width="27%" height="30" valign="middle"><font class="veri_baslik"><? echo stripslashes($ad); ?></font></td>
                  <td width="8%" height="30" valign="middle"><font class="veri_baslik"><? print ($puan);?></font></td>
 ...
 <td width="6%" align="center" valign="middle"><? if ($resim!='resimyok.gif' && file_exists($resim_dizini.$resim)) { if ($uzanti=="jpeg" || $uzanti=="jpg" || $uzanti=="gif") { ?>
                 ...
                 <? /* <div align="center">
                  <a href="../acente_detay/kontrol.php?haber_no=<? print($numara); ?>"><font class="altkategori">Acente Detay</font></a></div>
                  */ ?>                  </td>
				</tr>
				<?
					  }
