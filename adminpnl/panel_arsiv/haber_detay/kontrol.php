...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    <td width="50" class="td_anabaslik"><div align="center"><img src="../pictures/haber.gif" width="48" height="48"></div></td>
	...
	<a href="../haberler/kontrol.php" class="veri_ana_baslik">Fırsatlar(<? echo $haber_adi; ?>)</a> &gt;</font></td>
  </tr>
</table>
...
<tr> 
	...
	<table width="942" border="0" cellpadding="0" cellspacing="0">
     <tr>
       <td class="anabaslik">Haber Detayları</td>
     </tr>
	<?
		  ...
		  <tr> 
            <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr>
                  ...
                  <td width="60%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Resimler</strong></font></td>
                  <td width="8%">&nbsp;</td>
                  <td colspan="3">&nbsp;</td>
                  <td width="8%">&nbsp;</td>
                </tr>
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>">
                  ...
                  <td valign="middle"><font class="veri_baslik"><? echo stripslashes((strip_tags($icerik))); ?></font></td>
