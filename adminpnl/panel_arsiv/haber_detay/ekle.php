...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    <td width="50" class="td_anabaslik"><div align="left"><img src="../pictures/haber.gif" width="48" height="48"></div></td>
    <td width="902" class="td_anabaslik"><font class="veri_ana_baslik"><a href="../anaframe.php" class="veri_ana_baslik">Kontrol Panel</a> &gt;
	<a href="../haberler/kontrol.php" class="veri_ana_baslik">Haberler(<? echo $haber_adi; ?>)</a> &gt; 
	<a href="kontrol.php" class="veri_ana_baslik">Haber Detayları</a> ></font></td>
  </tr>
</table>
    ...
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
        <table width="942" border="0" align="center" cellpadding="4" cellspacing="6">
          <tr>
            <td colspan="3" class="anabaslik">Haber Detay Ekle </td>
          </tr>
          <tr> 
            <td width="184"></td>
            <td colspan="2">
