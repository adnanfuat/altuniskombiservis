...
include("config.php");
$item_resim_sil=@$baglanti->query("Select resim_adres,numara  from proje_detay  where altkategori_no=$altkategori")->fetchAll(PDO::FETCH_ASSOC);
...
$item_sil="Delete  from proje_detay  where altkategori_no=$altkategori";
