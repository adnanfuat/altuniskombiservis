...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
	...
	<a href="../proje_kategori/kontrol.php" class="veri_ana_baslik">Proje Kategorileri (<? print $ustkategori_adi; ?>)</a> &gt; 
	<a href="kontrol.php?ust_kategori_no=<? print $ustkategori_no; ?>"  class="veri_ana_baslik">Proje Alt Kategorileri  </a>&gt; 
	</font>
    </td>
  </tr>
</table>
      ...
      <td  valign="top"> 
       ...
       <? /*   <tr>
          ...
          <tr> 
            ...
            <span class="veri_tarih"><? echo $kck_m_w; ?>px-<? echo $kck_m_h; ?>px</span>
            </td>
          </tr>
          <tr> 
            <td height="32">&nbsp;</td>
...
<script>
function kontrol(){ if  (document.form1.ad.value==""){ alert("Lütfen Bir Ad Giriniz. "); } else	{ document.form1.submit();}	}
function lower(str) 
	{
