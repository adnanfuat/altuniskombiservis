...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
	...
	<a href="../proje_kategori/kontrol.php" class="veri_ana_baslik">Uygulama Kategori(<? print $ustkategori_adi; ?>)</a> &gt; 
    ...
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td  valign="top"> 
        <table width="944" border="0" align="center" cellpadding="4" cellspacing="6">
          <tr>
            <td colspan="2" class="anabaslik">Uygulama Alt Kategori Ekle </td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
            <td width="725">
