...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    ...
    <td width="97%" class="td_anabaslik"><font class="veri_ana_baslik"><a href="../anaframe.php" class="veri_ana_baslik" >Kontrol Panel</a> &gt; <a href="../proje_kategori/kontrol.php" class="veri_ana_baslik">Uygulama Kategorileri (<? echo $ust_kategori_adi; ?>)</a> &gt; </font></td>
  </tr>
</table>
   ...
   <tr>
      <td align="left" valign="top">
		    ...
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
    	      <tr>
        	    <td class="anabaslik">Uygulama Alt Kategorileri</td>
	          </tr>
			<?
          ...
          <tr> 
            <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="3">
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>">
                  ...
                  <td width="41%"><font class="veri_baslik"><strong><? print($ad); ?></strong></font></td>
                  <td width="13%"><div align="center">
                   <a href="../proje_detay/kontrol.php?alt_kategori=<? print($numara); ?>"  class="altkategori">UYGULAMALAR</a>
                  </div></td>
