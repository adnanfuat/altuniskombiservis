...
$item_resim_sil=@$baglanti->query("Select resim_adres,numara  from videolar  where kategori=$numara")->fetchAll(PDO::FETCH_ASSOC);
$item_resim_sayisi=count($item_resim_sil);
$item_dizini=$uzaklik."rsmlr/video/";
$item_thumb_dizini=$uzaklik."rsmlr/vresim/";
...
$item_sil="Delete  from videolar  where kategori=$numara";
