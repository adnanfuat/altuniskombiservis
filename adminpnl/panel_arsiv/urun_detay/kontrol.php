...
<style type="text/css">
body {background-color: #EFEFEF;margin-left: 0px;margin-top: 0px;margin-right: 0px;margin-bottom: 0px;}.style3 {color: #132C6A;font-weight: bold;}
</style>
...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
	...
	<font class="veri_ana_baslik"><a href="../anaframe.php" class="veri_ana_baslik">Kontrol Panel</a> &gt; <a href="../urun_kategori/kontrol.php" class="veri_ana_baslik">Ürün Kategorileri (<? print($ustkategori_adi); ?>)</a> &gt;	<a href="../urun_altkategori/kontrol.php" class="veri_ana_baslik">Ürün Alt Kategorileri (<? print($altkategori_adi);?>)</a> &gt;</font>
    </td>
  </tr>
</table>
        ...
        ?>
          <tr> 
            <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr>
                  <td colspan="15"><div align="right"><? include("navigation.php"); ?></div></td>
                </tr>
                <? } else { ?>
                ...
                <? /*  <input name="vitrin" type="submit" id="vitrin2" class="dugmeler_tasima" style="background-color:#00F" value="Vitrin"> */ ?>
				  <input name="tasi2" type="submit" id="tasi2" class="dugmeler_tasima" value="Taşı">
                   <input name="vitrin2" type="submit" id="vitrin2" class="dugmeler_aktif" value="Yeni" style="background:#009966">
                ...
                <tr>
                 <? /* <td width="35"><div align="center" class="style3"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> Vit.</font></div></td> */ ?>
                  <td width="3%"><div align="center"><span class="style3"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Taşı </font></span></div></td> 
                  <td width="3%"><div  align="center" class="style3"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> Y.</font></div></td>
                  <td width="3%"><div  align="center" class="style3"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> Ak.</font></div></td>
                  <td width="3%"><div align="center" class="style3"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> Sil</font></div></td>
                  <td width="13%"><div align="left" class="style3"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><? echo $kategori ?> Adı</font></div></td>
                  <td width="6%"><strong class="style3"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> Kod</font></strong></td>
                  <td width="16%"><strong class="style3"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> Barkod</font></strong></td>
                  <td width="12%">&nbsp;</td>
                  <td width="6%"><div align="center"><span class="veri_baslik">
                  ...
                  <td width="4%" align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><span class="style3">Puan</span></font></td>
                  <td width="6%">&nbsp;</td>
                  <td>&nbsp;</td>
                  <td width="8%">&nbsp;</td>
                  <td width="7%">&nbsp;</td>
             ...
             <? /*   <td height="45" class="tasima_tdler" style="background-color:#00F"><div align="center"><input  name="vitrin_no[<? print($numara);?>]" <? if ($vitrin=='1')  { print("checked"); }  ?> id="vitrin_no[<? print($numara);?>]"  type="checkbox" value="<? print($numara);?>" class="vselectedid" style="background-color:#00F"></div></td> */ ?>
                 ...
                 <td class="aktif_tdler" align="center" style="background:#009966"><input type="checkbox" <? if ($vitrin=='1')  { print("checked"); }  ?> name="vitrin_no[<? print($numara);?>]" id="vitrin_no[<? print($numara);?>]" value="<? print($numara);?>" class="vselectedid"></td>
                  ...
                  <td><font class="veri_baslik">&nbsp;<? echo $urun_kodu; ?></font></td>
                  <td><font class="veri_baslik">&nbsp;<? echo $fiyat; ?></font></td>
                  <td>
				  <br>
               	    <div align="left"> <img src="<? print $uzaklik; ?>rsmlr/gri_nokta.gif" width="12" height="12" align="absmiddle">  <a href="../dokumantasyon2/kontrol.php?numara=<? print($numara); ?>" class="resim_sil">ÜRÜN PDF</a></div> <br>
					 <div align="left"> <img src="<? print $uzaklik; ?>rsmlr/gri_nokta.gif" width="12" height="12" align="absmiddle">  <a href="../urunplan/kontrol.php?numara=<? print($numara);?>" class="resim_sil">BOYUT </a></div>
					 <br>
                    <div align="left"> <img src="<? print $uzaklik; ?>rsmlr/gri_nokta.gif" width="12" height="12" align="absmiddle">  <a href="../urunresim/kontrol.php?numara=<? print($numara);?>" class="resim_sil">KULLANIM </a></div>
                    <br>
                  <? if (1==2) { ?>
				   <div align="center"><a href="../urunresim/kontrol.php?numara=<? print($numara);?>" class="resim_sil">DİĞER RESİMLER</a></div> 
				  
                  <div align="center"><a href="../urunbilgi/kontrol.php?numara=<? print($numara);?>" class="resim_sil">TEKNİK ÖZELLİKLER</a></div> <? } ?></td>
                  <td><? if (1==2) { ?>
                  <div align="center"><a href="../urun_video/kontrol.php?numara=<? print($numara);?>" class="resim_sil">ÜRÜNE AİT VİDEO</a></div> <? } ?>
                  
                  <div align="center"><span class="veri_baslik">
                  ...
                  <td width="4%" align="center"><span class="veri_baslik">
					<? if ($resim!='resimyok.gif' && file_exists($resim_dizini_ortaboy.$resim)) 
                          { 
                    ?>
            ...
            <td><table width="100%" border="0" cellpadding="3" cellspacing="3">
                <tr>
                  ...
                  <table width="384" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                   <? /* <td width="42" align="center" class="tasima_tdler" title="Tümünü Seç/Seçimi Kaldır" style="background-color:#00F"><input  id="vselectall" type="checkbox"></td> */ ?>
                      <td width="2"></td>
                      <td width="28" height="30" align="center" class="tasima_tdler" title="Tümünü Seç/Seçimi Kaldır"><input  id="tselectall" type="checkbox"></td>
                      <td width="1"></td>
                      <td width="28" align="center" class="aktif_tdler"  style="background:#009966" title="Tümünü Seç/Seçimi Kaldır"><input  id="vselectall" type="checkbox"></td>
                      <td width="1"></td>
                      <td width="28" align="center" class="aktif_tdler" title="Tümünü Seç/Seçimi Kaldır"><input  id="aselectall" type="checkbox"></td>
                      <td width="1"></td>
                      <td width="28" align="center" class="sil_tdler" title="Tümünü Seç/Seçimi Kaldır"><input  id="sselectall" type="checkbox"></td>
                      <td width="1"></td>
                      <td width="295" class="veri_detay"><strong>Tümünü Seç/Seçimi Kaldır</strong></td>
                    </tr>
                  </table>
                  </td>
                </tr>
                <tr> 
                  ...
                  <input name="vitrin" type="submit" id="vitrin" class="dugmeler_tasima" style="background-color:#009966" value="Yeni"> 
