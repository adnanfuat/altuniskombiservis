...
if (isset($_SESSION['yonet']))
   {
	   ...
	   //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	   	   
		for ($sayac=1; $sayac<=20; $sayac++)
			{
				$n_ad=$_POST["ad".$sayac.""];
				$n_fiyat=$_POST["fiyat".$sayac.""];
				$n_resim=$_FILES["resim".$sayac.""];
				$n_puan=$_POST["puan".$sayac.""];
				$n_link=$_POST["link".$sayac.""];
			    if  (strlen(trim($n_ad))>0)
				    {
						$ekle_duzenle_sql="Insert into $tablo_ismi(ustkategori_no, ad, altkategori_no, aktif, eklenme_tarihi, puan, hit, aciklama, fiyat, link) 
										Values ('$ustkategori_no', '$n_ad', '$altkategori', '1', '$n_tarih', '$n_puan', '0', '', '$n_fiyat',  '$n_link')";
				...
				unset($_SESSION[$tablo_ismi.'n_fiyat'.$sayac.""]);
				unset($_SESSION[$tablo_ismi.'n_link'.$sayac.""]);
			}	   
