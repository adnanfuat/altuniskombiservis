...
if (isset($_SESSION['yonet']))
   {
		...
		$puan=$_POST["puan"];
		$dil=$_POST["dil"];	
		$bilgikategori=$_POST["bilgikategori"];	 //echo $bilgikategori;
		$ozet=$_POST["ozet"];	 
		...
		if (isset($err))
		   {
				...
				$_SESSION[$tablo_ismi.'bilgikategori']=$bilgikategori;
	  ...
	  else
		  {
				...
				if (isset($_SESSION[$tablo_ismi.'bilgikategori'])) {unset($_SESSION[$tablo_ismi.'bilgikategori']);}
