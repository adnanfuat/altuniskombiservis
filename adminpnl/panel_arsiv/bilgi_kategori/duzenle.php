...
if (isset($_SESSION['yonet']))
   {
		...
		if  (count($recordset)<>0)
			{	  
				...
				$dil=$recordset[0]["dil"];
				$bilgikategori=$recordset[0]["bilgikategori"];
				switch ($dil)
					{		
  ...
  <tr> 
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
       ...
       <tr>
         <td colspan="3" class="anabaslik">Bilgi  Düzenle</td>
       </tr>
          <tr> 
       ...
       <? if (1==5) { ?>   <tr>
            <td><span class="baslik"><strong>Bilgi Kategori *</strong></span></td>
            <td colspan="2" bgcolor="#F9F9F9"><? if (isset($_SESSION[$tablo_ismi.'bilgikategori'])) { $bilgikategori=$_SESSION[$tablo_ismi.'bilgikategori']; } ?>
          ...
          <tr> 
            ...
            <span class="veri_tarih">Tavsiye Edilen: <? echo $kck_m_w; ?>px*<? echo $kck_m_h; ?>px</span>
            </td>
