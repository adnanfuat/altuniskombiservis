...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    ...
    <td width="97%" class="td_anabaslik"><span class="veri_ana_baslik"><a href="../anaframe.php" class="veri_ana_baslik" >Kontrol Panel</a> &gt; <? echo $kategori ?> Kontrol </span></td>
  </tr>
</table>
      ...
      <td  align="left" valign="top">
		...
		?>
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
                  ...
                  <td width="44%" valign="middle"><font class="veri_baslik"><? print($ad); ?><? /* <? if (strlen($htaccess_etiket)>0) { ?><br><strong>Htaccess Etiket:</strong> <? echo $htaccess_etiket; ?> <? } ?> */ ?></font></td>
                  <td width="8%" valign="middle"><font class="veri_baslik"><? print ($puan);?></font></td>
                  <td width="8%" align="center" valign="middle"><font class="veri_baslik"><? print ($dil_aciklama);?></font></td>
                  <td colspan="2" valign="middle"><div align="center"><span class="style10"><a href="../urun_altkategori/kontrol.php?ust_kategori_no=<? print($numara); ?>" class="veri_baslik">ALT KATEGORİLER</a></span></div></td>
				  <? if ($resim=='') {$resim='resimyok.gif'; } ?>
                <td width="6%" align="center"><a href="duzenle.php?numara=<? print($numara);?>" class="duzenle"> <img src="../../rsmlr/duzenle.gif" alt="D&uuml;zenle" width="50" height="39" border="0"></a></td>
                <td width="4%" align="center">
                  ...
                  <td width="4%" align="center"><? if ($resim<>"resimyok.gif") {  if ($uzanti=="jpeg" || $uzanti=="jpg" || $uzanti=="gif") { ?>
