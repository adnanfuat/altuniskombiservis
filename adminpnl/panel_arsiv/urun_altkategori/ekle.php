...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
	...
	<a href="../urun_kategori/kontrol.php" class="veri_ana_baslik">Ürün Kategori(<? print $ustkategori_adi; ?>)</a> &gt; 
  ...
  <tr> 
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td  valign="top"> 
        <table width="944" border="0" align="center" cellpadding="4" cellspacing="6">
          ...
          <tr> 
			...
			<input name="ad" type="text" class="textbox1" id="ad" tabindex="1" onFocus="pchange(this, 1);"  onblur="pchange(this, 0);" value="<? if (isset($ad)) { echo $ad;} ?>"  size="55" onKeyUp="yoltanimla();"></td>
          </tr>
      ...
      <? /*     <tr> 
            ...
            <input name="arkaplan" type="text" class="textbox1"  onfocus="pchange(this, 1);"  onblur="pchange(this, 0);" value="<? if (isset($arkaplan)) {echo $arkaplan; }?>" size="55">
              </td>
          </tr> 
          ...
          <tr>
			...
			<input name="siralama" type="text" id="siralama"  value="<? echo $siralama ?>"  class="textbox1" size="10"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);"></td>
          </tr>
        <? /*   <tr> 
