...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    ...
    <td width="900" class="td_anabaslik"><div align="left"><font class="veri_ana_baslik"><a href="../anaframe.php" class="veri_ana_baslik" >Kontrol Panel</a> &gt;
          <a href="../referans_kategori/kontrol.php" class="veri_ana_baslik">Referans Kategorileri</a> &gt; </font></div></td>
  </tr>
</table>
...
<form  name="xxx" action="kontrol_islem.php" method="post">
      ...
      <tr><td class="anabaslik">Referanslar (<? echo $ust_kategori_adi; ?>)</td>
      </tr>
<?
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                ...
                <tr>
                  ...
                  <td width="49%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>  Referans Adı </strong></font></td>
                  <td width="20%">&nbsp;</td>
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>">
                  ...
                  <td valign="middle" ><div align="center"><span class="style10 style5"> <a href="../referans_resim/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik">RESİMLER</a></span></div></td>
                  <td width="5%" valign="middle" class="veri_detay" ><div align="center"><? echo $siralama; ?></div></td>
