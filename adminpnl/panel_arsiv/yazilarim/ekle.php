...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
	...
	<a href="kontrol.php" class="veri_ana_baslik">Yazılarım</a> &gt;</span></td>
  </tr>
</table>
    ...
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
        <table width="942" border="0" align="center" cellpadding="4" cellspacing="6">
          <tr>
            <td colspan="3" class="anabaslik">Yazı Ekle</td>
          </tr>
          <tr> 
            <td></td>
            <td colspan="2">
          ...
          <tr> 
            <td width="184"><strong class="baslik">Yazı Başlığı *</strong></td>
          ...
          <tr> 
            ...
            <input name="htaccess_etiket" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($htaccess_etiket)) {echo $htaccess_etiket; }?>" size="55"> <span class="veri_baslik">* Eğer Htaccess Etiket kısmında özel karakterler var ise kaldırmalısınız ( ! , ? , + , % , & , ' , . , $ , # , * , ; , , , )  vs. gibi</span>
              </td>
          </tr>
          <? if (1==2) { ?>
          <tr>
