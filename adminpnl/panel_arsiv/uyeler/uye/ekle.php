...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
    ...
    <td width="890" class="td_anabaslik"><span class="veri_ana_baslik"><a href="../../anaframe.php" class="veri_ana_baslik" >Kontrol Panel</a> &gt;<a href="kontrol.php" class="veri_ana_baslik"> Üyeler</a> &gt;</span></td>
  </tr>
</table>
...
<tr> 
		  ...
		  <tr> 
            ...
            <td bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'n_oda'])) { $oda=$_SESSION[$tablo_ismi.'n_oda']; } ?>
          ...
          <tr> 
            ...
            <td bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'n_sicil'])) { $sicil=$_SESSION[$tablo_ismi.'n_sicil']; } ?>
          ...
          <tr> 
            ...
            <td bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'n_sifre'])) { $sifre=$_SESSION[$tablo_ismi.'n_sifre']; } ?>
