  		...
  		if (isset($err))
		   {
				...
				$_SESSION[$tablo_ismi.'sifre']=$sifre;
				$_SESSION[$tablo_ismi.'adres']=$adres;
				$_SESSION[$tablo_ismi.'oda']=$oda;
				$_SESSION[$tablo_ismi.'sicil']=$sicil;
		...
		else
	       {
				...
				unset($_SESSION[$tablo_ismi.'sifre']);
				unset($_SESSION[$tablo_ismi.'adres']);
				unset($_SESSION[$tablo_ismi.'oda']);
				unset($_SESSION[$tablo_ismi.'sicil']);
