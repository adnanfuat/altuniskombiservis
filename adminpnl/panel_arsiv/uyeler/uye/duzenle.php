...
if (isset($_SESSION['yonet']))
   {
		...
		if  (count($recordset)<>0)
			{	  
				$ad=$recordset[0]["ad"];
				$telefon=$recordset[0]["tel"];
				$sifre=$recordset[0]["sifre"];
				$adres=$recordset[0]["adres"];
				$oda=$recordset[0]["oda"];
				$sicil=$recordset[0]["sicil"];
...
<table width="950" border="0" align="center" cellpadding="3" cellspacing="0">
  <tr> 
	...
	<span class="veri_ana_baslik"><a href="../../anaframe.php" class="veri_ana_baslik">Kontrol Panel</a> &gt; <a href="kontrol.php" class="veri_ana_baslik">Üyeler</a> &gt;</span></td>
  </tr>
</table>
        ...
        <table width="942" border="0" align="center" cellpadding="4" cellspacing="6">
          ...
          <tr> 
			...
			<input name="ad" type="text" id="ad"  value="<? echo $ad ?>"  class="textbox1" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);">           </td>
               ...
               <tr> 
            <td width="184"><strong class="baslik">Telefon </strong></td>
            <td bgcolor="#F9F9F9" colspan="2" >
            <? if (isset($_SESSION[$tablo_ismi.'telefon'])) { $telefon=$_SESSION[$tablo_ismi.'telefon']; } ?>
			<input name="telefon" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($telefon)) {echo $telefon; }?>" size="55">
            </td>
          </tr>

		<? if(1==2) { ?>	
          <tr> 
            <td width="184"><strong class="baslik">Adres</strong></td>
            <td bgcolor="#F9F9F9" colspan="2" >
            <? if (isset($_SESSION[$tablo_ismi.'adres'])) { $adres=$_SESSION[$tablo_ismi.'adres']; } ?>
			<input name="adres" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($adres)) {echo $adres; }?>" size="55">
            </td>
          </tr>
          <? } ?>
          <tr> 
            <td width="184"><strong class="baslik">Kayıtlı Oda</strong></td>
            <td bgcolor="#F9F9F9" colspan="2" >
            <? if (isset($_SESSION[$tablo_ismi.'oda'])) { $oda=$_SESSION[$tablo_ismi.'oda']; } ?>
            <input name="oda" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($oda)) {echo $oda; }?>" size="55">
            </td>
          </tr>
          <tr> 
            <td width="184"><strong class="baslik">Sicil No</strong></td>
            <td bgcolor="#F9F9F9" colspan="2" >
            <? if (isset($_SESSION[$tablo_ismi.'sicil'])) { $sicil=$_SESSION[$tablo_ismi.'sicil']; } ?>
            <input name="sicil" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($sicil)) {echo $sicil; }?>" size="55">
            </td>
          </tr>
          <tr> 
			...
			<input name="eposta" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($eposta)) {echo $eposta; }?>" size="55">
               ...
               <tr> 
            <td width="184"><strong class="baslik">Şifre </strong></td>
            <td bgcolor="#F9F9F9" colspan="2">
            <? if (isset($_SESSION[$tablo_ismi.'sifre'])) { $sifre=$_SESSION[$tablo_ismi.'sifre']; } ?>
			<input name="sifre" type="text" class="textbox1"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($sifre)) {echo $sifre; }?>" size="55">
            </td>
          </tr>
