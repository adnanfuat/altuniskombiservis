		...
		if  (isset($err))
			{
				...
				$_SESSION[$tablo_ismi.'n_sifre']=$n_sifre;
				$_SESSION[$tablo_ismi.'n_adres']=$n_adres;
				$_SESSION[$tablo_ismi.'n_oda']=$n_oda;
				$_SESSION[$tablo_ismi.'n_sicil']=$n_sicil;
		...
		else
			{
				...
				unset($_SESSION[$tablo_ismi.'n_sifre']);
				unset($_SESSION[$tablo_ismi.'n_adres']);
				unset($_SESSION[$tablo_ismi.'n_oda']);
				unset($_SESSION[$tablo_ismi.'n_sicil']);
