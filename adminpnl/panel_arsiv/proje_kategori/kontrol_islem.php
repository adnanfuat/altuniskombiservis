		 ...
		 if  (isset($_GET["item"]))
			 {
				...
				if (file_exists($dosya_gecici_isim.".jpg")){$parametre2=$dosya_gecici_isim.".jpg";@chmod($parametre2,0755);
				@unlink($parametre2);}
				if (file_exists($dosya_gecici_isim.".gif")){$parametre2=$dosya_gecici_isim.".gif";@chmod($parametre2,0755);
				@unlink($parametre2);}
				$resim_sil=@$baglanti->query("Update urun_kategori set resim_adres='' where numara='$item'");
