          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                ...
                <tr>
                  ...
                  <td><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Dosya Linki</strong></font></td>
                  <td>&nbsp;</td>
                </tr>
				 <?
                ...
                <tr>
                  ...
                  <td width="28%" valign="middle" bgcolor="#F7F7F7"><font class="veri_baslik"><? echo $dil_aciklama; ?></font></td>
                  <td valign="middle" bgcolor="#F7F7F7">&nbsp;<a href="<? print($dosya_dizini.$dosya); ?>" target="_blank" title="Görmek için tıklayınız"><img src="<? print $uzaklik; ?>rsmlr/buyutec.gif" width="12" height="12" align="absmiddle"> <? //print($dosya_dizini.$dosya); ?></a></td>
                  <td width="6%" valign="middle" bgcolor="#F7F7F7">
