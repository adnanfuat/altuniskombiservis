		...
		if  (file_exists($dosya_dizini.$dosya) && $dosya_dizini.$dosya<>$dosya_dizini)
			{
				...
				$html.="<td class='table_border1'><strong> Baba E-posta </strong></td>";
				$html.="</tr>";
						...
						for ($row=2; $row<=$highestRow; $row++)
							{
								...
								$baba_mail=$baglanti->quote($worksheet->getCellByColumnAndRow(5,$row)->getValue(),$baglanti);
								$sifre=$baglanti->quote($worksheet->getCellByColumnAndRow(6,$row)->getValue(),$baglanti);
								$telefon=$baglanti->quote($worksheet->getCellByColumnAndRow(7,$row)->getValue(),$baglanti);
								...
								if  (count($bu_tckimlik_kayitlimi)==0) // Bu TC kimlik sisteme kayıtlı degil ise kayıt edilecek (s)
									{
										...
										$insert_sql="Insert into uyeler (ad, soyad, tckimlik, faks, eposta, eklenme_tarihi, sifre, telefon, aktif) Values ('$ogrenci_adi', '$ogrenci_soyadi', '$ogrenci_tckimlik', '$baba_adi_soyadi', '$baba_mail', '$eklenme_tarihi', '$sifre', '$telefon', '1')";
										//echo $insert_sql;
										@$baglanti->query($insert_sql)->fetchAll(PDO::FETCH_ASSOC);
										
										$html.="<tr class='veri_baslik'>";
										$html.="<td class='table_border1'> I-".$eklenme_tarihi." </td>";
										...
										$html.="<td class='table_border1'> ".$sifre." </td>";
										$html.="<td class='table_border1'> ".$baba_adi_soyadi." </td>";
										$html.="<td class='table_border1'> ".$baba_mail." </td>";
										$html.="<td class='table_border1'> ".$telefon." </td>";
										$html.="</tr>";
									}
								else
									{
										//$kayit_numara=
										//$update_sql="Update uyeler set ad='$ogrenci_adi'[soyad='$ogrenci_soyadi'][ faks='$baba_adi_soyadi', eposta='$baba_mail', sifre='$sifre'  where tckimlik='$ogrenci_tckimlik'";
										//echo $insert_sql;
										...
										$baba_mail=$bu_tckimlik_kayitlimi[0]["eposta"];
										$telefon=$bu_tckimlik_kayitlimi[0]["telefon"];
									
										
										$html.="<tr class='veri_baslik'>";
										$html.="<td class='table_border1'> U-".$eklenme_tarihi." </td>";
										$html.="<td class='table_border1' > ".$ogrenci_adi." </td>";
										$html.="<td class='table_border1'> ".$ogrenci_soyadi." </td>";
										$html.="<td class='table_border1' > ".$ogrenci_tckimlik." </td>";
