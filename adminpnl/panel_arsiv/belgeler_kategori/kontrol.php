...
if (isset($_SESSION['yonet']))
   {
		...
		$sql_cumlesi="select * from $tablo_ismi order by dil asc, puan asc limit $limit_ilk_deger,$bir_sayfadaki_toplam_kayit_sayisi";
...
?>
          <tr> 
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
               <tr>
                 <td colspan="9" class="anabaslik">Belge Kategorileri</td>
               </tr>
			   <? if ($toplam_sayfa_sayisi>0) { ?>
                ...
                <tr> 
                  ...
                  <td colspan="4"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Kategori Adı </strong></font></td>
                  <td colspan="2">&nbsp;</td>
                  <td width="13%">&nbsp;</td>
                </tr>
				<?
				   for   ($sayac=0; $sayac<$toplam_kayit_sayisi; $sayac++)
						 {
							...
							if ($dil==1) { $dil_ad="Türkçe"; } else { $dil_ad="İngilizce"; }
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
                  ...
                  <td width="10%" valign="middle"><div align="center" class="veri_detay"><? echo $dil_ad; ?></div></td>
                  <td width="6%" valign="middle"><div align="center" class="veri_detay"><? echo $puan; ?></div></td>
				  <td width="14%" valign="middle"><div align="center"><span class="style10"> <a href="../belgeler/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik">BELGELER</a></span></div></td>
				  <td width="8%"><div align="center"><a href="<? print($resim_dizini.$resim); ?>" target="_blank">
				...
				<table width="100%" height="65">
                  <tr> 
                    <td height="61"><div align="center">
                      <p>&nbsp;</p>
                      <p class="style5">&nbsp;</p>
                      <p class="kayit_yok">Bu kategoride kay�t bulunamam��t�r. </p>
                      <p class="style5">&nbsp;</p>
                      <p class="style5">&nbsp;</p>
                      <p class="style5">&nbsp;</p>
                      <p>
