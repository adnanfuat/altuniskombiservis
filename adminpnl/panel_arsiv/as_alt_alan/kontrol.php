        ...
        ?>
          <tr> 
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  <td colspan="7" class="anabaslik">Reklamlar</td>
                </tr>
               <? 
			   ...
			   ?>
                ...
                <tr> 
                  ...
                  <td width="32%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> Reklam Adı </strong></font></td>
                ...
                <tr  onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
                  ...
                  <td valign="middle" class="veri_baslik">
                  <? if(1==2) { ?>
                  <a href="../mobil_manset/kontrol.php?haber_no=<? print($numara); ?>"><font class="altkategori">MOBİL RESMİ</font></a>
                  <? } ?>
                  </td>
			    </tr>
				<?
