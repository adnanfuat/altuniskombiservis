        ...
        ?>
          <tr> 
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  <td colspan="7" class="anabaslik">Manşet Reklamlar</td>
                </tr>
               <? 
			   ...
			   ?>
                ...
                <tr> 
                  ...
                  <td width="48%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> Reklam Adı </strong></font></td>
                  <td width="10%">&nbsp;</td>
                  <td width="8%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> Dil </strong></font></td>
                  <td width="8%"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Puan</strong></font></td>
                  <td width="18%" align="left"><font color="#132C6A" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Resim</strong></font></td>
                </tr>
				<?
                for ($sayac=0; $sayac<$toplam_kayit_sayisi; $sayac++)
                    {
                        ...
                        if ($uzanti=="swf") { $img="swf.gif"; } else if ($uzanti=="gif"){ $img="gif.gif"; } else if ($uzanti=="png"){ $img="png.gif"; } else {$img="jpeg.gif";}
                ...
                <tr  onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
				  ...
				  <a href="duzenle.php?numara=<? print($numara);?>" class="veri_baslik" style="text-decoration:none; " title="Düzenlemek için Tıklayınız">
				  <? print($ad); ?></a>
				  </strong></font></td>
                  <td align="center" valign="middle"> <a href="duzenle.php?numara=<? print($numara);?>" class="duzenle"><img src="../../rsmlr/duzenle.gif" alt="Düzenle" width="50" height="39" border="0"></a></td>
                  <td valign="middle"  class="veri_baslik"><? print($dil_aciklama);?></td>
                  <td valign="middle" class="veri_baslik"><? print($puan); ?></td>
                  <td align="center" valign="middle"><div align="left"><a href="<? print($resim_dizini.$resim); ?>"  target="_blank">
				  <img src="../../rsmlr/<? print $img;  ?>" hspace="10" border="0" align="absmiddle" width="43" ></a><span class="style10"><? print $resim; ?></span></div></td>
                </tr>
				<?
                      }
                ?>
