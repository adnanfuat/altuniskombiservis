          ...
          <tr> 
            ...
            <table width="100%"  border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td height="15"><div align="center"><span  class="veri_tarih">*.png</span></div></td>
              </tr>
              <tr>
                ...
                <td><div align="center"><img src="../../rsmlr/png.gif" width="43" height="43"></div></td>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#F9F9F9"><input name="resim2" type="file" id="resim2"  class="textbox1" onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" size="46">
                          <span class="veri_tarih"><a href="<? print($resim_dizini.$resim2); ?>" class="textbox_yardim" target="_blank">(<? print($resim2); ?>)</a></span> </td>
                      <td bgcolor="#F9F9F9"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="15"><div align="center"><span  class="veri_tarih">*.jpg</span></div></td>
                            <td height="15"><div align="center"><span  class="veri_tarih">*.gif</span></div></td>
                            <td height="15"><div align="center"><span  class="veri_tarih">*.png</span></div></td>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#F9F9F9"><input name="resim3" type="file" id="resim3"  class="textbox1" onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" size="46">
