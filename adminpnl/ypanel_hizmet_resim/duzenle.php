                                    ...
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item seprate">
                                             ...
                                             <li class="list-inline-item"><a href="../ypanel_hizmet_kategori/kontrol.php">Hizmet Kategorileri (<? echo $hizmet_ad; ?>)</a> &gt;</li>
                                            <li class="list-inline-item"><a href="kontrol.php"  class="veri_ana_baslik">Hizmet Resimler</a> &gt;</li>
                                        </ul>
                                    </div>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row" style="background:#FFFFFF"> 
                                    ...
                                    <table width="950" border="0" align="left" cellspacing="0"  class="table">
  <tr> 
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
      <td  valign="top"> 
        <div align="center">
          <table border="0" align="left" cellpadding="4" cellspacing="6" style="max-width:923px">
          <tr>
            <td colspan="2" class="anabaslik">Hizmet ResimDüzenle</td>
          </tr>
            <tr> 
            ...
            <tr> 
			  ...
			  <input name="ad" type="text" class="form-control" id="ad"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? print(stripslashes($ad)); ?>" size="55" onKeyUp="yoltanimla();">              </td>
            </tr>
           ...
           <input name="htaccess_etiket" type="text" id="htaccess_etiket"  value="<? echo $htaccess_etiket ?>"  class="form-control" size="55" onBlur="pchange(this, 0);" onFocus="pchange(this, 1);"></td>
            ...
            <tr> 
			  ...
			  <textarea name="aciklama" cols="80" rows="25" id="editor" class="<? /* mceAdvanced */ ?>form-control"><? echo stripslashes($aciklama); ?></textarea>              </td>
            </tr>
            <? } ?>
            <tr>
