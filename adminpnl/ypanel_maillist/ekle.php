                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="kontrol.php">Form Mail Yönetimi</a> &gt;</li>
                                        </ul>
                                    </div>
    ...
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data" >
      <td valign="top"> 
        <table border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
          <tr>
            <td colspan="2" class="anabaslik"> <p>Mail Ekle</p></td>
          </tr>
          <tr> 
            <td></td>
            <td>
          ...
          <tr> 
			...
			<input name="eposta" type="text"  class="form-control"onfocus="pchange(this, 1);"  onblur="pchange(this, 0);" value="<? if (isset($eposta)) {echo $eposta; }?>" size="55">
            </td>
          </tr>
