...
<body class="animsition" onLoad="javascript:document.form1.ad.focus()">
	...
	<a href="../ypanel_proje_altkategori/kontrol.php"  >Proje Alt Kategorileri (<? print($altkategori_adi);?>)</a> &gt; 
    ...
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td  valign="top"> 
          ...
          <table  border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
            <tr>
              <td colspan="2" class="anabaslik">Proje Ekle</td>
            </tr>
            <tr> 
              <td>&nbsp;</td>
              <td >
            ...
            <tr> 
              ...
              <td bgcolor="#F9F9F9">
                ...
                <input name="ad" type="text" id="ad"  value="<? if (isset($ad)) { print($ad); }?>" class="form-control" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);" onKeyUp="yoltanimla();">
                <font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000">              
                <? if (isset($_SESSION[$tablo_ismi.'n_hata'])) 
                        {
                            $hata=$_SESSION[$tablo_ismi.'n_hata'];	if (isset($hata[1]) && $hata[1]==1 ) { echo 'Proje Adını Giriniz';}
                        }
                ?>
                </font>                </td>
            </tr>
          ...
          */ ?>
            <tr>
			  ...
			  <? if (isset($_SESSION[$tablo_ismi.'n_hata'])) 
                    {
                          $hata=$_SESSION[$tablo_ismi.'n_hata'];	if (isset($hata[4]) && $hata[4]==1 ) { echo 'Proje Puanını Giriniz';}
                    }
              ?>
              </font></td>
            </tr>
           ...
           <tr>
              ...
              <td bgcolor="#F9F9F9">
                ...
                <textarea name="aciklama"  id="editor"   rows="50" class=<? /* mceAdvanced */ ?>"form-control" ><? if (isset($aciklama)) { print $aciklama; } ?></textarea>
                ...
                <? if (isset($_SESSION[$tablo_ismi.'n_hata'])) 
					  {
							...
							if (isset($hata[6]) && $hata[6]==1 ) { echo 'Proje Açıklamasını Giriniz';}
					  }
				?>
              </font>              </td>
            </tr>
       ...
       <? if (1==2) { ?>      <tr> 
            <td >Video Link</td>
            <td bgcolor="#F9F9F9">
              <? if (isset($_SESSION[$tablo_ismi.'n_proje_kodu'])) { $proje_kodu=$_SESSION[$tablo_ismi.'n_proje_kodu']; } ?>
			  <input name="proje_kodu" type="text" class="form-control"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($proje_kodu)) {echo $proje_kodu; }?>"   size="55">            </td>
          </tr>
