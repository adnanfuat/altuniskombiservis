...
if (isset($_SESSION['yonet']))
   {
	 ...
	 if  (isset($_GET["item"]) && 1==2)
		 { 
			   ...
			   if (file_exists($dosya_gecici_isim.".jpg")) { $parametre2=$dosya_gecici_isim.".jpg";	@chmod($parametre2,0755); @unlink($parametre2); }
			  if (file_exists($dosya_gecici_isim.".gif"))  { $parametre2=$dosya_gecici_isim.".gif"; @chmod($parametre2,0755); @unlink($parametre2); }												  
  ...
  if (isset($_POST["ekle"]) || isset($_POST["ekle2"]))   
 	 {    	
		if (isset($_SESSION[$tablo_ismi.'n_adi']))	 { unset($_SESSION[$tablo_ismi.'n_adi']); }
		if (isset($_SESSION[$tablo_ismi.'n_aciklama']))	{	unset($_SESSION[$tablo_ismi.'n_aciklama']); }
		if (isset($_SESSION[$tablo_ismi.'n_teknikozellikler']))	{	unset($_SESSION[$tablo_ismi.'n_teknikozellikler']); }
		...
		if (isset($_SESSION[$tablo_ismi.'n_resim']))	{	unset($_SESSION[$tablo_ismi.'n_resim']); }
 ...
 if  (isset($_POST["sil"]) || isset($_POST["sil2"]))
	 {  
		 ...
		 if (isset($_POST["silinecekler_numara"]))
			...
			$sql_cumlesi="select numara from $tablo_ismi where ustkategori_no=$ustkategori_no and altkategori_no=$altkategori_no";
