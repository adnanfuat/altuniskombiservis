                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="../ypanel_proje_kategori/kontrol.php" >Proje Kategorileri (<? print($ustkategori_adi); ?>)</a> &gt;	<a href="../ypanel_proje_altkategori/kontrol.php" >Proje Alt Kategorileri (<? print($altkategori_adi);?>)</a> &gt;</li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                        <i class="fas fa-boxes"></i>Projeler</h3>
                                            ...
                                            <tbody>
															...
															for ($sayac=0; $sayac<$toplam_kayit_sayisi; $sayac++)
																{
																	...
																	$proje_kodu=$recordset[$sayac]["proje_kodu"];
                                                                       ...
                                                                       <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="table-data__info">
                                                                                <span><? // echo $proje_kodu; ?> <? print($ad); ?></span>
                                                                        ...
                                                                        <td>
                                                                          ...
                                                                          <? /*   <a href="../ypanel_proje_dokumantasyon/kontrol.php?numara=<? print($numara); ?>" title="Proje Dokümanları"  ><i class="fas fa-file-pdf"></i></a> &nbsp;&nbsp;
                                                                            <a href="../ypanel_projeplan/kontrol.php?numara=<?  print($numara);?>"  title="Proje Renkleri"  ><i class="fas fa-paint-brush"></i></a>&nbsp;&nbsp;
                                                                             */ ?>
                                                                             <a href="../ypanel_projeresim/kontrol.php?numara=<? print($numara);?>"  title="Proje Diğer Fotoğrafları"><i class="far fa-images"></i></a>
                                                                        </td>
                                                                        <td>
                                                    ...
                                                    <tr> 
                                                        <td style="border:0; ">
                                                                ...
                                                                <input name="sil2" type="submit" id="sil2" class="btn btn-info btn-sm"  value=" Sil " ><br><br>
