...
if  (isset($_SESSION['yonet']))
    {
		 ...
		 // $syonetim=$_SESSION["siteyonetici"];
		  ...
		  if (count($haber_adi_ogren)>0) 
			 ...
			 {
				  header("Location:../etiketler/kontrol.php"); 	
			 }	
?>	
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="../ypanel_etiketler/kontrol.php" >Yeni Sayfalar (<? echo stripslashes($haber_adi); ?>)</a> &gt; </li>
                                      </ul>
                                    </div>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                        <i class="far fa-images"></i> Yeni Sayfa Detay Resimleri</h3>
