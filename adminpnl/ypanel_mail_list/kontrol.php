                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                        <i class="fas fa-list"></i>Maillist Yönetimi</h3>
                                            ...
                                            <thead>
                                                    <tr> 
                                                        <td style="border:0; ">
                                                                ...
                                                                <input name="aktar" type="button" id="aktar"   class="btn btn-primary btn-sm" value="Dışar Aktar" onClick="window.location='mailleri_disari_aktar.php';">
                                                        </td>
                                              </tr>
                                            </thead>
