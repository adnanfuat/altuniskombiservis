    ...
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td  valign="top"> 
        <table  border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px;">
          <tr><td colspan="2" class="anabaslik">Hizmet Ekle</td></tr>
          <tr> 
            <td>&nbsp;</td>
            <td width="726">
            <font class="hata1"> 
            ...
            <td bgcolor="#F9F9F9">
			  ...
			  <input name="ad" type="text" class="form-control"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($ad)) { echo  stripslashes($ad); }?>" size="55" onKeyUp="yoltanimla();">            </td>
          </tr>
          <tr> 
          ...
          <? if (1==2) { ?>
          <tr> 
            <td width="185"><strong class="baslik">Hizmet Görsel Linki</strong></td>
            <td bgcolor="#F9F9F9">
              <? if (isset($_SESSION[$tablo_ismi.'n_gorsel'])) { $gorsel=$_SESSION[$tablo_ismi.'n_gorsel']; } ?>
			  <input name="gorsel" type="text" class="form-control"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($gorsel)) {echo $gorsel; }?>" size="55">         </td>
          </tr>
          <tr> 
            <td width="185"><strong class="baslik">Hizmet Referans Linki</strong></td>
            <td bgcolor="#F9F9F9">
              <? if (isset($_SESSION[$tablo_ismi.'n_referans'])) { $referans=$_SESSION[$tablo_ismi.'n_referans']; } ?>
			  <input name="referans" type="text" class="form-control"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($referans)) {echo $referans; }?>" size="55">            </td>
          </tr>
          <? } ?>
        ...
        <? if (1==2) { ?>  <tr>
          ...
          <tr>
            ...
            <textarea name="aciklama" cols="80" rows="25" id="editor" class="<? /* mceAdvanced */ ?>form-control"><? if (isset($aciklama)) { print stripslashes($aciklama); } ?></textarea></td>
          </tr>
          <tr>
            <td><font class="baslik">Sıralama</font></td>
            <td bgcolor="#F9F9F9">
              <? if (isset($_SESSION[$tablo_ismi.'n_puan'])) { $puan=$_SESSION[$tablo_ismi.'n_puan']; } ?>
              <input name="puan" type="text" class="form-control" id="puan"  onFocus="pchange(this, 1);"  onBlur="pchange(this, 0);" value="<? if (isset($puan)) {echo $puan; }?>" size="10">            </td>
          </tr>
          <? if (1==2) { ?>
			<tr> 
            <td width="185"><strong class="baslik">Renk</strong></td>
            <td bgcolor="#F9F9F9" class="baslik">
			  <input type="radio" name="renk" value="k" checked> Kırmızı
 			  <input type="radio" name="renk" value="s"> Siyah
            </td>
          </tr>
          <? } ?>
          <tr> 
