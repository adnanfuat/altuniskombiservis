  ...
  <tr> 
     <form  name="xxx" action="kontrol_islem.php" method="post">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr><td class="anabaslik">Projeler</td></tr>
         <?
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr onMouseOver="bgColor='#EEFACB'" onMouseOut="bgColor='<? echo $tr_back; ?>'"   bgcolor="<? echo $tr_back; ?>"> 
                  ...
                  <td width="29%" valign="middle" ><font class="veri_baslik"><? print($ad); ?></font></td>
                  <td width="4%" valign="middle" ><font class="veri_baslik"><? print($puan); ?></font></td>
                  <td width="5%" align="center" valign="middle" ><font class="veri_baslik"><strong><? print($dil_aciklama); ?> </strong><br>
<? print($hizmetkategori_aciklama); ?></font></td>
				  <td width="12%" valign="middle"><? if (1==1) { ?><div align="center"><a href="../hizmet_video/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik"><strong>Slide Video</strong></a></div><? } ?></td>
                  <td width="12%" valign="middle"><? /*if (1==2) { */ ?><div align="center">
                  <a href="../hizmet_resim/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik"><strong>Diğer Resim</strong></a>
                  
                  <a href="../slider_resim/kontrol.php?kategori=<? print($numara); ?>" class="veri_baslik"><strong>Slide Resim</strong></a>
