...
<body class="animsition" onLoad="document.form1.ad.focus();">
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="kontrol.php">Haberler </a> &gt;</li>
                                        </ul>
                                    </div>
  ...
  <tr> 
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
        <table  border="0"   cellpadding="4" cellspacing="6" style="max-width:923px">
          <tr>
         ...
         <? if (1==1) { ?> <tr>
            ...
            <td colspan="2" bgcolor="#F9F9F9">
              <? if (isset($_SESSION[$tablo_ismi.'ozet'])) { $ozet=$_SESSION[$tablo_ismi.'ozet']; } ?>
                <textarea name="ozet" cols="50" rows="5" class="form-control" wrap="physical" onKeyDown="textCounter(form1.ozet,form1.ozet_uzunluk,430);" onKeyUp="textCounter(form1.ozet,form1.ozet_uzunluk,430);" ><? echo stripslashes($ozet); ?></textarea>
				<!--<br><br>
          ...
          <tr>
            ...
            <? if (isset($_SESSION[$tablo_ismi.'icerik'])) {$icerik=$_SESSION[$tablo_ismi.'icerik'];   } ?>
             ...
             <textarea name="icerik" id="editor" class="<? /* mceAdvanced */ ?>form-control"><? echo stripslashes($icerik); ?></textarea>		</td>
          </tr>
          <tr> 
            <td>Resim</td>
            <td   bgcolor="#F9F9F9">
          ...
          <tr> 
            <td colspan="3"><table   border="0" align="center" cellpadding="2" cellspacing="4">
                <tr> 
                  <td  >&nbsp;</td>
