                            ...
                            <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
                              <td valign="top"> 
                                <table  border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px;">
                                 ...
                                 <? if (1==1) { ?>  <tr>
                                    <td valign="middle"><? echo $kategori_ad; ?> Özet * </td>
                                    <td colspan="2" bgcolor="#F9F9F9">
                                      <? if (isset($_SESSION[$tablo_ismi.'n_ozet'])) { $ozet=$_SESSION[$tablo_ismi.'n_ozet']; } ?>
                                      <textarea name="ozet" cols="50" rows="4" class="form-control" wrap="physical" 
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="2" bgcolor="#F9F9F9">
                                      ...
                                      <textarea name="icerik" id="editor" class="<? /* mceAdvanced */ ?>form-control"><? if (isset($icerik)) { print stripslashes($icerik); } ?></textarea>
                                      </td>
                                  </tr>
                                  <tr> 
                                    <td>Resim</td>
