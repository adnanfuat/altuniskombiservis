        ...
        <div class="page-container2">
            ...
            <section>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                       <i class="fas fa-file-alt"></i> Haber Yönetimi</h3>
				...
				?>
                                                                       ...
                                                                       <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="table-data__info">
                                                                                <span><? echo stripslashes($ad); ?></span>
                                                                       ...
                                                                       <td>
                                                                     <a href="../ypanel_haber_detay/kontrol.php?haber_no=<? print($numara); ?>" class="veri_baslik">DİĞER RESİMLER <i class="fas fa-plus"></i></a>
                                                                     </td>
                                                                      <td>
