    ...
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td valign="top"> 
        <table   border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
          <tr>
            <td colspan="3" class="anabaslik">Haber Detay Resim Ekle </td>
          </tr>
          <tr> 
            <td width="184"></td>
            <td colspan="2">
          ...
          <tr>
            ...
            <td colspan="2" bgcolor="#F9F9F9">
              ...
              <? /* <textarea name="icerik" cols="90" rows="25" class="mceAdvanced"><? if (isset($icerik)) { print stripslashes($icerik); } ?></textarea> */ ?>
               <input name="icerik" type="text" id="icerik"  value="<? if (isset($icerik)) { print($icerik); }?>" class="form-control" size="55"  onBlur="pchange(this, 0);" onFocus="pchange(this, 1);" >
              </td>
          </tr>
          <? if (1==2) { ?> 
          <tr>
          ...
          <tr> 
            ...
            <td colspan="2">
              ...
              <input name="Submit2" type="button" class="btn btn-info btn-sm"  id="Submit2" onClick="javascript:history.back()"  value="Geri Dön">
			</td>
          </tr>
         <? /*  <tr> 
            <td colspan="3">
