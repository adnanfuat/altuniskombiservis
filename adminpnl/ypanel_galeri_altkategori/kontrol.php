                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="../ypanel_galeri_kategori/kontrol.php">Galeri Kategorileri (<? echo $ust_kategori_adi; ?>)</a> &gt;</li>
                                        </ul>
                                    </div>
                ...
                <div class="section__content section__content--p30">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                        <i class="fas fa-images"></i>Galeri Alt Kategorileri</h3>
                  ...
                  <i class="fas fa-crop"  alt="Resmi Yeniden Boyutlandır"  title="Resmi Yeniden Boyutlandır"></i></a><? } } ?>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="../ypanel_galeri_detay/kontrol.php?alt_kategori=<? print($numara); ?>" class="veri_baslik">Foto Ekle / Düzenle <i class="fas fa-plus"></i></a>
                                                                        </td>
                                                                        <td>
