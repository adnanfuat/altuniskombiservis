...
if (isset($_SESSION['yonet']))
   {
		...
		$ustkategori_ad=@$baglanti->query("Select ad from galeri_kategori where numara='$ust_kategori_no'")->fetchAll(PDO::FETCH_ASSOC);
		$ustkategori_ad=$ustkategori_ad[0]["ad"];

		$diger_kategoriler=@$baglanti->query("Select numara,ad from galeri_kategori where numara<>'$ust_kategori_no'")->fetchAll(PDO::FETCH_ASSOC);
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="../ypanel_galeri_kategori/kontrol.php"  >Galeri Kategori(<? echo $ustkategori_ad;?>)</a> &gt; 
