...
if (isset($_POST["gizli"]))
   ...
   {
		$sql_cumlesi="select max(numara) from $tablo_ismi where ustkategori_no='$ust_kategori_no'";
...
if (isset($_POST["gizli2_ust_kategori_no"]))
   {
	  $ust_kategori_no=$_POST["gizli2_ust_kategori_no"];
   }
