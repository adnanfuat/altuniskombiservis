                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="kontrol.php">E-Katalog Yönetimi </a> &gt;</li>
                                        </ul>
                                    </div>
  ...
  <tr> 
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data" >
      <td valign="top" bordercolor="#C0C0C0" bgcolor="#FFFFFF" > 
        <table  align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
          <tr>
            <td colspan="2" class="anabaslik">E-Katalog Ekle</td>
          </tr>
          <tr> 
            <td ></td>
            <td >
          ...
          <tr>
            ...
            <input name="ad" type="text" class="form-control" id="ad" value="<? echo $ad; ?>" size="55"></td>
          </tr>
<tr>
          ...
          <tr> 
            <td>Dosya *</td>
            <td bgcolor="#F9F9F9">
            <input name="dosya" type="file" class="form-control" onFocus="pchange(this, 1);"  onblur="pchange(this, 0);" size="46">			</td>
          </tr>
