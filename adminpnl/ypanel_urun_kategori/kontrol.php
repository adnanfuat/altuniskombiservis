                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                        <i class="fas fa-boxes"></i>Ürün Kategorileri</h3>
                  ...
                  <? } ?>
                                                                       ...
                                                                       <!-- <img src="../../rsmlr/crop2.png" width="24" height="25" alt="Resmi Yeniden Boyutlandır"  title="Resmi Yeniden Boyutlandır" border=0  > -->
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="../ypanel_urun_altkategori/kontrol.php?ust_kategori_no=<? print($numara); ?>" class="veri_baslik">ALT KATEGORİ <i class="fas fa-plus"></i></a>
                                                                        </td>
                                                                        <td>
