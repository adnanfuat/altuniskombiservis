		...
		if  (isset($_FILES["video"]) && strlen($_FILES["video"]["name"])!=0) //  && $_FILES["video"]["type"]=="application/octet-stream"
	        {
			   ...
			   if ($dosya_size>$max_file_size || $dosya_size2>$max_file_size)
	              ...
	              {				 
			            $ekle="Insert into $tablo_ismi (ad,kaynak,aktif,durum,dil,aciklama,htaccess_etiket,puan) Values ('$n_ad','$n_kaynak','1','$n_durum','$n_dil','$n_aciklama','$n_htaccess_etiket','$n_puan')";
