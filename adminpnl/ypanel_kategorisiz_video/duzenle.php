    ...
    <form name="form1" method="post" action="duzenle_islem.php" enctype="multipart/form-data">
      <td  valign="top" bordercolor="#C0C0C0" bgcolor="#FFFFFF"> 
        <table  border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
          ...
          <? if (1==2) { ?>     <tr>
            <td><span class="baslik">Durum *</span></td>
          ...
          <tr> 
           ...
           <a href="<? echo $resim_dizini.$resim; ?>" target="_blank"><? echo $resim; ?></a> <span style="font-size:10px">Tavsiye Edurumen Boyut: <? echo $kck_m_w; ?>px*<? echo $kck_m_h; ?>px</span></td>
          </tr>
          <tr>
            <td>Video Seç **</td>
            <td bgcolor="#F9F9F9">
              <input name="video" type="file" id="video"  class="form-control" onFocus="pchange(this, 1);"  onblur="pchange(this, 0);" size="46">
