                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="kontrol.php"  class="veri_ana_baslik">Videolar</a> &gt;</li>
                                        </ul>
                                    </div>
  ...
  <tr> 
    <form name="form1" method="post" action="ekle_islem.php" enctype="multipart/form-data">
      <td  valign="top" bordercolor="#C0C0C0" bgcolor="#FFFFFF" > 
        <table width="100%" border="0"  cellpadding="4" cellspacing="6" style="max-width:923px">
          <tr>
       ...
       <? if (1==2) { ?>   <tr>
            <td><font class="baslik">Durum</font></td>
          <td bgcolor="#F9F9F9">
          ...
          <tr>
            ...
            <input name="ad" type="text" class="form-control" id="ad" value="<? echo $ad; ?>" size="55" onKeyUp="yoltanimla();"></td>
          </tr>
           <tr>
            <td class="baslik">Puan</td>
            <td bgcolor="#F9F9F9">
            <? if (isset($_SESSION[$tablo_ismi.'n_puan'])) { $puan=$_SESSION[$tablo_ismi.'n_puan']; } ?>
            <input name="puan" type="text" class="form-control" id="puan" value="<? echo $puan; ?>" size="55" ></td>
          </tr>
          <tr> 
            <td width="127" class="baslik">Htaccess *</td>
            <td bgcolor="#F9F9F9">
          ...
          <tr> 
            <td>Video Seç **</td>
            <td bgcolor="#F9F9F9">
              <input name="video" type="file" class="form-control" onFocus="pchange(this,1);"  onblur="pchange(this, 0);" size="46">
              <span style="font-size:10px">Tavsiye Edilen Boyut: <? echo $kck_m_w; ?>px*<? echo $kck_m_h; ?>px</span></td>
          </tr>
       <? if (1==1) {  ?>     <tr>
          ...
          <tr>
            ...
            <textarea name="kaynak" cols="80" rows="10" class="form-control" id="kaynak"><? echo $kaynak; ?></textarea></td>
          </tr>
		<? /*   <tr>
            <td>&nbsp;</td>
            <td bgcolor="#F9F9F9" class="veri_tarih">Dış kaynaklardan video kullanmak için video sitesinden alacağınız video EMBED kodunu yukarıya giriniz. <br>
              !!! Eğer dış kaynak videoyu ana sayfaya çağıracaksanız genişlik ve yüksekliğini 100% * 530 olarak değiştirmelisiniz.</td>
          </tr> */ ?>
		  <? } ?>
          ...
          <tr>
            <td height="32">&nbsp;</td>
            <td><div align="left"><span  style="font-size:10px">Max. Dosya Boyutu:<? print $max_file_size/1024; ?> Mb</span></div></td>
          </tr>
                </table>
      </td>
    </form>
