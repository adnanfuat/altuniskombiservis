        ...
        <div class="page-container2">
            ...
            <section>
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="user-data m-b-40">
                                    <h3 class="title-3 m-b-30">
                                        <i class="fas fa-file-video"></i>Videolar</h3>
                                                ...
                                                <tr>
                                                    <td>   <!--<label class="au-checkbox">
                                                            ...
                                                            <span class="au-checkmark"></span>
                                                         				...
                                                         				<table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:70px; padding:0; margin:0">
                                                                              <tr>
                                                                             
                                                                                <td width="50%" style="border:0;padding:0; margin:0; ">Aktif</td>
                                                                                <td width="50%" style="border:0;padding:0;  margin:0; "> Sil </td>
                                                                          </tr>
                                                                            </table>
                                            			...
                                            			<?                  for ($sayac=0; $sayac<$toplam_kayit_sayisi; $sayac++)
                     {
						...
						{		
							...
							case 2: $durum_aciklama="Ana Sayfada Görünsün"; break;
						}
															...
															?>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:70px; padding:0; margin:">
                                                                              <tr>
                                                                              	
                                                                            
                                                                                <td width="50%"  style="border:0;padding:0;  margin:0;  "><label class="au-checkbox">
				   ...
				   <a href="<? print($resim_dizini.$resim); ?>" rel="external" target="_blank">
				   <i class="fas fa-eye"  title="Resmi Gör"  alt="Resmi Gör"></i></a>
				   <? } ?>     
