      ...
      <td valign="top"> 
        <table width="100%" border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
          ...
          <tr> 
			...
			<input name="ad" type="text" id="ad" class="form-control" size="55"  onblur="pchange(this, 0);" onFocus="pchange(this, 1);"   value="<? echo stripslashes($ad) ?>">
            <span class="hata1">
            <? 
          ...
          <tr>
            ...
            <td bgcolor="#F9F9F9"><? if (isset($_SESSION[$tablo_ismi.'telefon'])) { $telefon=$_SESSION[$tablo_ismi.'telefon']; } ?>
                <input name="telefon" type="text" id="telefon"  value="<? echo $telefon; ?>" class="form-control" size="55"  onblur="pchange(this, 0);" onFocus="pchange(this, 1);" >
                <span class="hata1">
                <? 
			  if (isset($_SESSION[$tablo_ismi.'hata'])) 
					{
          ...
          <tr>
			...
			<? if (isset($_SESSION[$tablo_ismi.'eposta'])) { $eposta=$_SESSION[$tablo_ismi.'eposta']; } ?>
              <input name="eposta" type="text" id="eposta"  value="<? echo $eposta; ?>" class="form-control" size="55"  onblur="pchange(this, 0);" onFocus="pchange(this, 1);" >
              <span class="hata1">
              <? 
			  if (isset($_SESSION[$tablo_ismi.'hata'])) 
					{
          ...
          <tr>
            ...
            <td bgcolor="#F9F9F9">
              ...
              <textarea name="mesaj" id="mesaj" cols="55" rows="10" class="form-control"><? print stripslashes($mesaj); ?></textarea>
              <span class="hata1">
			  <? 
			  if (isset($_SESSION[$tablo_ismi.'hata'])) 
				 {
       ...
       <? if (1==2) { ?>  <tr>
          ...
          <tr> 
            <td height="32"></td>
            <td>
              <input name="kaydet" type="button" id="kaydet" class="btn btn-success btn-sm" value="Kaydet" onClick="kontrol()">
