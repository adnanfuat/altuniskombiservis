                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item"><a href="kontrol.php">Ziyaretçi Defteri</a> &gt;</li>
                                        </ul>
                                    </div>
        ...
        <table width="100%" border="0" align="center" cellpadding="4" cellspacing="6" style="max-width:923px">
          ...
          <tr> 
            ...
            <td bgcolor="#F9F9F9">
			  ...
			  <input name="ad" type="text" class="form-control" id="ad"  onfocus="pchange(this, 1);"  onblur="pchange(this, 0);" value="<? if (isset($ad)) {echo $ad; }?>" size="55">            </td>
          </tr>
          <tr>
            ...
            <input name="telefon" type="text" class="form-control" id="telefon"  onfocus="pchange(this, 1);"  onblur="pchange(this, 0);" value="<? if (isset($telefon)) {echo $telefon; }?>" size="55">            </td>
          </tr>
          <tr>
            ...
            <td bgcolor="#F9F9F9"><? if (isset($_SESSION[$tablo_ismi.'n_eposta'])) { $eposta=$_SESSION[$tablo_ismi.'n_eposta']; } ?>
              <input name="eposta" type="text" class="form-control" id="eposta"  onfocus="pchange(this, 1);"  onblur="pchange(this, 0);" value="<? if (isset($eposta)) {echo $eposta; }?>" size="55">              </td>
          </tr>
          <tr>
            <td><font class="baslik">Mesaj *</font></td>
            <td bgcolor="#F9F9F9">
			  <? if (isset($_SESSION[$tablo_ismi.'n_mesaj'])) {$mesaj=$_SESSION[$tablo_ismi.'n_mesaj']; } ?>
              <textarea name="mesaj" cols="55"  rows="10" class="form-control" id="mesaj"><? if (isset($mesaj)) { print $mesaj; } ?></textarea>
              <span class="hata1">
				<? 
